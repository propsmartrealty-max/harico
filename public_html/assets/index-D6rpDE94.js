(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=t(r);fetch(r.href,o)}})();function we(){const e=document.createElement("header");e.className="header-pill-wrapper",window.addEventListener("scroll",()=>{window.scrollY>25?e.classList.add("scrolled"):e.classList.remove("scrolled");const t=["home","builder-legacy","projects","project-comparison","specifications","location-hub","amenities","emi-calculator","faq","contact"];let i="";t.forEach(r=>{const o=document.getElementById(r);if(o){const s=o.offsetTop;window.scrollY>=s-160&&(i=r)}}),document.querySelectorAll(".pill-nav-link").forEach(r=>{r.classList.remove("active");const o=r.getAttribute("data-target");(o===i||i==="builder-legacy"&&o==="home")&&r.classList.add("active")})}),e.innerHTML=`
  ...
  `,e.appendChild(t),setTimeout(()=>{const i=e.querySelectorAll(".legacy-filter-btn"),r=e.querySelectorAll(".milestone-card-refined");i.forEach(o=>{o.addEventListener("click",()=>{i.forEach(l=>l.classList.remove("active")),o.classList.add("active");const s=o.getAttribute("data-era");r.forEach(l=>{s==="all"||l.classList.contains(`era-${s}`)?l.style.display="flex":l.style.display="none"})})})},0),e}function se(e){const a=document.createElement("article");a.className="project-card-3d card-3d-tilt liquid-glass-card";const t=e.slug||e.id;return a.onclick=i=>{const r=i.target;r.closest("button")||r.closest("a")||r.closest(".card-rera-interactive")||g.navigate(`/project/${t}`)},a.innerHTML=`
...
`;class W{static instance;observer=null;isTouchDevice=!1;cursorGlow=null;targetMouseX=0;targetMouseY=0;currentMouseX=0;currentMouseY=0;isCursorGlowActive=!1;constructor(){this.isTouchDevice="ontouchstart"in window||navigator.maxTouchPoints>0}static getInstance(){return W.instance||(W.instance=new W),W.instance}init(){this.setupScrollObserver(),this.initCounters(),this.isTouchDevice||(this.init3DTilt(),this.initMagneticButtons(),this.initCursorGlow(),this.initScrollParallax(),this.initLiquidGlass())}initCursorGlow(){if(this.cursorGlow||this.isTouchDevice)return;this.cursorGlow=document.createElement("div"),this.cursorGlow.id="cursor-glow-spotlight",this.cursorGlow.className="cursor-glow-spotlight",document.body.appendChild(this.cursorGlow),window.addEventListener("mousemove",t=>{this.targetMouseX=t.clientX,this.targetMouseY=t.clientY,!this.isCursorGlowActive&&this.cursorGlow&&(this.cursorGlow.style.opacity="1",this.isCursorGlowActive=!0)}),document.addEventListener("mouseleave",()=>{this.cursorGlow&&(this.cursorGlow.style.opacity="0",this.isCursorGlowActive=!1)});const a=()=>{this.isCursorGlowActive&&this.cursorGlow&&(this.currentMouseX+=(this.targetMouseX-this.currentMouseX)*.12,this.currentMouseY+=(this.targetMouseY-this.currentMouseY)*.12,this.cursorGlow.style.transform=`translate3d(${this.currentMouseX-200}px, ${this.currentMouseY-200}px, 0)`),requestAnimationFrame(a)};requestAnimationFrame(a)}setupScrollObserver(){this.observer&&this.observer.disconnect();const a={root:null,rootMargin:"0px 0px -50px 0px",threshold:.1};this.observer=new IntersectionObserver(t=>{t.forEach(i=>{if(i.isIntersecting){const r=i.target;r.classList.add("lux-in-view"),r.querySelectorAll("[data-counter-target]").forEach(s=>this.animateCounter(s)),this.observer?.unobserve(r)}})},a),document.querySelectorAll(".lux-reveal, .lux-stagger, .section, .milestone-card-refined, .project-card-3d").forEach(t=>{this.observer?.observe(t)})}initCounters(){document.querySelectorAll("[data-counter-target]").forEach(a=>{const t=a.getBoundingClientRect();t.top<window.innerHeight&&t.bottom>=0&&this.animateCounter(a)})}animateCounter(a){if(a.dataset.counterAnimated==="true")return;a.dataset.counterAnimated="true";const t=a.dataset.counterTarget||"0",i=parseFloat(t.replace(/[^0-9.]/g,"")),r=a.dataset.counterPrefix||"",o=a.dataset.counterSuffix||"",s=2200,l=performance.now(),n=d=>{const u=d-l,p=Math.min(u/s,1),w=p===1?1:1-Math.pow(2,-10*p),b=Math.floor(w*i);a.textContent=`${r}${b.toLocaleString("en-IN")}${o}`,p<1?requestAnimationFrame(n):a.textContent=`${r}${i.toLocaleString("en-IN")}${o}`};requestAnimationFrame(n)}init3DTilt(){document.querySelectorAll(".card-3d-tilt, .milestone-card-refined").forEach(t=>{let i;const r=()=>{i=t.getBoundingClientRect(),t.style.transition="transform 0.12s ease-out, box-shadow 0.3s ease"},o=l=>{i||(i=t.getBoundingClientRect());const n=l.clientX-i.left,d=l.clientY-i.top,u=n/i.width*100,p=d/i.height*100,w=n/i.width-.5,b=d/i.height-.5,S=w*14,q=-b*14;t.style.transform=`perspective(1000px) rotateX(${q.toFixed(2)}deg) rotateY(${S.toFixed(2)}deg) scale3d(1.02, 1.02, 1.02)`;const v=t.querySelector(".card-glare-overlay");v&&(v.style.opacity="1",v.style.background=`radial-gradient(circle 280px at ${u}% ${p}%, rgba(255, 255, 255, 0.3), rgba(212, 175, 55, 0.16) 40%, transparent 80%)`)},s=()=>{t.style.transition="transform 0.6s cubic-bezier(0.16, 1, 0.3, 1), box-shadow 0.6s ease",t.style.transform="perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1)";const l=t.querySelector(".card-glare-overlay");l&&(l.style.opacity="0")};t.removeEventListener("mouseenter",r),t.removeEventListener("mousemove",o),t.removeEventListener("mouseleave",s),t.addEventListener("mouseenter",r),t.addEventListener("mousemove",o),t.addEventListener("mouseleave",s)})}initMagneticButtons(){document.querySelectorAll(".btn-magnetic, .btn-primary, .btn-whatsapp").forEach(t=>{t.addEventListener("mousemove",i=>{const r=t.getBoundingClientRect(),o=i.clientX-r.left-r.width/2,s=i.clientY-r.top-r.height/2;t.style.transform=`translate(${o*.2}px, ${s*.2}px)`}),t.addEventListener("mouseleave",()=>{t.style.transform="translate(0px, 0px)"})})}initScrollParallax(){window.addEventListener("scroll",()=>{const a=window.scrollY,t=document.querySelector(".hero-bg-media");t&&a<window.innerHeight&&(t.style.transform=`translate3d(0, ${(a*.3).toFixed(1)}px, 0)`)},{passive:!0})}initLiquidGlass(){document.querySelectorAll(".liquid-glass-card, .project-card-3d, .hero-finder-card, .milestone-card-refined, .pill-navbar, .quick-bar-container, .modal-content-advanced, .lightbox-dialog, .spec-tech-card, .amenity-luxury-card").forEach(t=>{let i;const r=()=>{i=t.getBoundingClientRect()},o=s=>{i||(i=t.getBoundingClientRect());const l=s.clientX-i.left,n=s.clientY-i.top,d=(l/i.width*100).toFixed(1),u=(n/i.height*100).toFixed(1);t.style.setProperty("--mouse-x",`${d}%`),t.style.setProperty("--mouse-y",`${u}%`)};t.removeEventListener("mouseenter",r),t.removeEventListener("mousemove",o),t.addEventListener("mouseenter",r),t.addEventListener("mousemove",o)})}}const x=W.getInstance(),re=Object.values(A);function ne(){const e=document.createElement("section");e.id="projects",e.className="section projects-section lux-reveal",e.innerHTML=`
  ...
  `,e.appendChild(a),setTimeout(()=>{e.querySelector("#contact-hub-form")?.addEventListener("submit",i=>{i.preventDefault();const r=e.querySelector("#contact-name")?.value,o=e.querySelector("#contact-phone")?.value,s=e.querySelector("#contact-project")?.value,l=e.querySelector("#contact-slot")?.value,n=e.querySelector("#contact-msg")?.value;me({name:r,phone:o,project:s,timeSlot:l,message:n,interestType:"VIP Site Visit Booking"});let d=`*VIP Site Visit Booking Request* 🏛️
...
_Lead dispatched to propsmartrealty@gmail.com_`,window.open(`https://wa.me/917744009295?text=${encodeURIComponent(d)}`,"_blank"),i.target.reset()})},0),e}function Be(){const e=document.createElement("footer");e.className="footer-section",e.innerHTML=`
  ...
  `;const a=e.querySelector(".close-btn-adv"),t=e.querySelector("#advEnquireForm"),i=e.querySelectorAll(".project-chip"),r=e.querySelector("#advSubmitBtn"),o=r.querySelector(".btn-text"),s=r.querySelector(".btn-loader");let l="Harico Diwaam (Kiwale)";i.forEach(p=>{p.addEventListener("click",()=>{i.forEach(w=>w.classList.remove("active")),p.classList.add("active"),l=p.dataset.project||"Harico Estates"})});const n=()=>{e.classList.add("hidden")};a.addEventListener("click",n),e.addEventListener("click",p=>{p.target===e&&n()}),t.addEventListener("submit",p=>{p.preventDefault();const w=e.querySelector("#adv-name"),b=e.querySelector("#adv-phone"),S=e.querySelector("#adv-email"),q=e.querySelector("#adv-config"),v=e.querySelector("#adv-intent");o.classList.add("hidden"),s.classList.remove("hidden"),r.disabled=!0;const f={name:w.value.trim(),phone:b.value.trim(),email:S.value.trim(),project:l,requirement:q.value,interestType:v.value};me(f);const D="917744009295";let H=`*VIP Priority Enquiry — Harico Estates* 🏡
...
_Please send the official brochure, cost sheet, and schedule our VIP site visit._`;const F=`https://wa.me/${D}?text=${encodeURIComponent(H)}`;setTimeout(()=>{window.open(F,"_blank"),n(),t.reset(),o.classList.remove("hidden"),s.classList.add("hidden"),r.disabled=!1},600)}),window.showEnquireModal=p=>{p&&i.forEach(w=>{const b=w.dataset.project||"";(b.toLowerCase().includes(p.toLowerCase())||p.toLowerCase().includes(b.toLowerCase()))&&(i.forEach(S=>S.classList.remove("active")),w.classList.add("active"),l=b)}),e.classList.remove("hidden")};let d=!1;document.addEventListener("mouseleave",p=>{p.clientY<=0&&!d&&e.classList.contains("hidden")&&!sessionStorage.getItem("exit_modal_shown")&&(d=!0,sessionStorage.setItem("exit_modal_shown","true"),window.showEnquireModal())});const u=document.createElement("style");return u.textContent=`
  ...
  `,e.appendChild(r),e}function Ae(){const e=document.createElement("aside");e.className="mobile-quick-action-bar",e.setAttribute("aria-label","Quick Contact"),e.innerHTML=`
  ...
  `,a.appendChild(t),a}function qe(e){const a=document.createElement("div");a.className="config-section";const t=e.configurations||[];a.innerHTML=`
  ...
  `,a.appendChild(i),a}function Te(e){const a=document.createElement("div");a.className="project-details-page";const t=document.createElement("div");t.className="pd-hero",t.style.backgroundImage=`url('${e.image}')`,t.innerHTML=`
  ...
  `;const i=Le(e),r=document.createElement("div");r.className="pd-content-wrapper section";const o=document.createElement("div");o.className="container";const s=document.createElement("div");s.className="about-section mb-xl",s.id="about";const l=(e.highlights||[]).map(m=>`
  ...
  `;const n=qe(e);n.id="pricing";const d=document.createElement("div");d.className="bank-partners-section mt-xl p-lg rounded-lg bg-white border text-center";const u=e.bankPartners||["State Bank of India","HDFC Bank","ICICI Bank","Axis Bank","Bank of Baroda"];d.innerHTML=`
  ...
  `;const T=document.createElement("div");T.className="section bg-light",T.innerHTML=`
    <div class="container">
      <div class="section-header text-center mb-xl">
  ...
  `,a.appendChild(t),a.appendChild(i);const k=document.createElement("div");k.className="pd-sections-wrapper",o.appendChild(s),k.appendChild(o),k.appendChild(f);const j=document.createElement("div");j.className="section container",j.appendChild(n),j.appendChild(d),k.appendChild(j),k.appendChild(D),k.appendChild(p),k.appendChild(H),k.appendChild(F),k.appendChild(O),k.appendChild(T),a.appendChild(k),a.appendChild(N);const U=document.createElement("style");return U.textContent=`
    .pd-hero {
      height: 65vh;
      min-height: 520px;
      width: 100%;
  ...
  `,a.appendChild(o),a}const te=[{slug:"harico-estates-overview",title:"Harico Estates Pune: Developer Profile, Sentosa Legacy & Master Portfolio Guide",subtitle:"Everything homebuyers and investors need to know about Harico Estates, Sentosa Developers’ 39-year track record, and landmark projects in Punawale and Kiwale.",metaDescription:"Complete guide to Harico Estates Pune by Sentosa Developers. Explore ongoing projects (Harico Diwaam, Harico Edge, Harico Pride), 39-year legacy, and 100% MahaRERA transparency.",keywords:"Harico Estates, Harico Estates Pune, Sentosa Developers Pune, Sentosa Harico, Harico Group, Harico Punawale, Harico Kiwale, Harico Diwaam, Harico Edge, Harico Pride, Real Estate Developer West Pune, हरिको इस्टेट्स पुणे",category:"Developer Profile",readTime:"7 min read",publishDate:"2026-03-01",author:"Harico Estates Research Desk",image:"/assets/harico-edge-hero.png",summary:"Harico Estates represents the modern residential development arm of Sentosa Developers, a trusted real estate and hospitality group with 39+ years of engineering excellence in Pune. This comprehensive profile covers corporate heritage, design philosophy, and flagship residential portfolios.",keyTakeaways:["Backed by Sentosa Developers with a 39-year legacy (founded in 1987) and 20+ delivered landmarks across Pune.","100% MahaRERA registered developments: Harico Diwaam (PR1260002502389), Harico Edge (P52100031773), and Harico Pride (P52100018471).","Pioneering Mivan monolithic concrete engineering for crack-resistant, seismic-safe high-rise homes.","Prime strategic locations: Punawale (near Bhumkar Chowk) and Kiwale (opposite Sentosa Water Park) within 2 minutes of the Mumbai-Pune Expressway."],contentHtml:`
    ...
    `,faqs:[{q:"Is Punawale more expensive than Kiwale?",a:"Punawale prices average ₹6,800–₹7,600/sq.ft due to its direct border with Wakad. Kiwale averages ₹6,200–₹7,000/sq.ft, offering a slightly more accessible entry point starting at ₹70.00 Lacs*."},{q:"Which area has better expressway connectivity: Punawale or Kiwale?",a:"Both offer 2-minute access to the Mumbai-Pune Expressway. Kiwale has direct expressway frontage opposite Sentosa Water Park, while Punawale connects via the Punawale underpass near Bhumkar Chowk."}]}];function ze(){const e=document.createElement("section");return e.className="section articles-hub-section lux-reveal",e.innerHTML=`
    <div class="container py-xl">
  ...
  `,e}function We(e){const a=document.createElement("article");a.className="section article-detail-section lux-reveal";const t=te.filter(i=>i.slug!==e.slug).slice(0,3);return a.innerHTML=`
