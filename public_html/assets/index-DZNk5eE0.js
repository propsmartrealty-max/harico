(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=t(r);fetch(r.href,o)}})();function we(){const e=document.createElement("header");e.className="header-pill-wrapper",window.addEventListener("scroll",()=>{window.scrollY>25?e.classList.add("scrolled"):e.classList.remove("scrolled");const t=["home","builder-legacy","projects","project-comparison","specifications","location-hub","amenities","emi-calculator","faq","contact"];let i="";t.forEach(r=>{const o=document.getElementById(r);if(o){const s=o.offsetTop;window.scrollY>=s-160&&(i=r)}}),document.querySelectorAll(".pill-nav-link").forEach(r=>{r.classList.remove("active");const o=r.getAttribute("data-target");(o===i||i==="builder-legacy"&&o==="home")&&r.classList.add("active")})}),e.innerHTML=`
  ...
  `,e.appendChild(t),setTimeout(()=>{const i=e.querySelectorAll(".legacy-filter-btn"),r=e.querySelectorAll(".milestone-card-refined");i.forEach(o=>{o.addEventListener("click",()=>{i.forEach(n=>n.classList.remove("active")),o.classList.add("active");const s=o.getAttribute("data-era");r.forEach(n=>{s==="all"||n.classList.contains(`era-${s}`)?n.style.display="flex":n.style.display="none"})})})},0),e}function se(e){const a=document.createElement("article");a.className="project-card-3d card-3d-tilt liquid-glass-card";const t=e.slug||e.id;return a.onclick=i=>{const r=i.target;r.closest("button")||r.closest("a")||r.closest(".card-rera-interactive")||g.navigate(`/project/${t}`)},a.innerHTML=`
  ...
  `,setTimeout(()=>{a.querySelectorAll(".btn-explore-trigger, .btn-explore-action").forEach(r=>{r.addEventListener("click",o=>{o.stopPropagation();const s=r.getAttribute("data-slug");s&&g.navigate(`/project/${s}`)})})},0),a}const ye=`
  .project-card-3d {
    background: #FFFFFF;
    border-radius: 20px;
    overflow: hidden;
...
`;class W{static instance;observer=null;isTouchDevice=!1;cursorGlow=null;targetMouseX=0;targetMouseY=0;currentMouseX=0;currentMouseY=0;isCursorGlowActive=!1;constructor(){this.isTouchDevice="ontouchstart"in window||navigator.maxTouchPoints>0}static getInstance(){return W.instance||(W.instance=new W),W.instance}init(){this.setupScrollObserver(),this.initCounters(),this.isTouchDevice||(this.init3DTilt(),this.initMagneticButtons(),this.initCursorGlow(),this.initScrollParallax(),this.initLiquidGlass())}initCursorGlow(){if(this.cursorGlow||this.isTouchDevice)return;this.cursorGlow=document.createElement("div"),this.cursorGlow.id="cursor-glow-spotlight",this.cursorGlow.className="cursor-glow-spotlight",document.body.appendChild(this.cursorGlow),window.addEventListener("mousemove",t=>{this.targetMouseX=t.clientX,this.targetMouseY=t.clientY,!this.isCursorGlowActive&&this.cursorGlow&&(this.cursorGlow.style.opacity="1",this.isCursorGlowActive=!0)}),document.addEventListener("mouseleave",()=>{this.cursorGlow&&(this.cursorGlow.style.opacity="0",this.isCursorGlowActive=!1)});const a=()=>{this.isCursorGlowActive&&this.cursorGlow&&(this.currentMouseX+=(this.targetMouseX-this.currentMouseX)*.12,this.currentMouseY+=(this.targetMouseY-this.currentMouseY)*.12,this.cursorGlow.style.transform=`translate3d(${this.currentMouseX-200}px, ${this.currentMouseY-200}px, 0)`),requestAnimationFrame(a)};requestAnimationFrame(a)}setupScrollObserver(){this.observer&&this.observer.disconnect();const a={root:null,rootMargin:"0px 0px -50px 0px",threshold:.1};this.observer=new IntersectionObserver(t=>{t.forEach(i=>{if(i.isIntersecting){const r=i.target;r.classList.add("lux-in-view"),r.querySelectorAll("[data-counter-target]").forEach(s=>this.animateCounter(s)),this.observer?.unobserve(r)}})},a),document.querySelectorAll(".lux-reveal, .lux-stagger, .section, .milestone-card-refined, .project-card-3d").forEach(t=>{this.observer?.observe(t)})}initCounters(){document.querySelectorAll("[data-counter-target]").forEach(a=>{const t=a.getBoundingClientRect();t.top<window.innerHeight&&t.bottom>=0&&this.animateCounter(a)})}animateCounter(a){if(a.dataset.counterAnimated==="true")return;a.dataset.counterAnimated="true";const t=a.dataset.counterTarget||"0",i=parseFloat(t.replace(/[^0-9.]/g,"")),r=a.dataset.counterPrefix||"",o=a.dataset.counterSuffix||"",s=2200,n=performance.now(),l=d=>{const u=d-n,p=Math.min(u/s,1),w=p===1?1:1-Math.pow(2,-10*p),b=Math.floor(w*i);a.textContent=`${r}${b.toLocaleString("en-IN")}${o}`,p<1?requestAnimationFrame(l):a.textContent=`${r}${i.toLocaleString("en-IN")}${o}`};requestAnimationFrame(l)}init3DTilt(){document.querySelectorAll(".card-3d-tilt, .milestone-card-refined").forEach(t=>{let i;const r=()=>{i=t.getBoundingClientRect(),t.style.transition="transform 0.12s ease-out, box-shadow 0.3s ease"},o=n=>{i||(i=t.getBoundingClientRect());const l=n.clientX-i.left,d=n.clientY-i.top,u=l/i.width*100,p=d/i.height*100,w=l/i.width-.5,b=d/i.height-.5,S=w*14,T=-b*14;t.style.transform=`perspective(1000px) rotateX(${T.toFixed(2)}deg) rotateY(${S.toFixed(2)}deg) scale3d(1.02, 1.02, 1.02)`;const v=t.querySelector(".card-glare-overlay");v&&(v.style.opacity="1",v.style.background=`radial-gradient(circle 280px at ${u}% ${p}%, rgba(255, 255, 255, 0.3), rgba(212, 175, 55, 0.16) 40%, transparent 80%)`)},s=()=>{t.style.transition="transform 0.6s cubic-bezier(0.16, 1, 0.3, 1), box-shadow 0.6s ease",t.style.transform="perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1)";const n=t.querySelector(".card-glare-overlay");n&&(n.style.opacity="0")};t.removeEventListener("mouseenter",r),t.removeEventListener("mousemove",o),t.removeEventListener("mouseleave",s),t.addEventListener("mouseenter",r),t.addEventListener("mousemove",o),t.addEventListener("mouseleave",s)})}initMagneticButtons(){document.querySelectorAll(".btn-magnetic, .btn-primary, .btn-whatsapp").forEach(t=>{t.addEventListener("mousemove",i=>{const r=t.getBoundingClientRect(),o=i.clientX-r.left-r.width/2,s=i.clientY-r.top-r.height/2;t.style.transform=`translate(${o*.2}px, ${s*.2}px)`}),t.addEventListener("mouseleave",()=>{t.style.transform="translate(0px, 0px)"})})}initScrollParallax(){window.addEventListener("scroll",()=>{const a=window.scrollY,t=document.querySelector(".hero-bg-media");t&&a<window.innerHeight&&(t.style.transform=`translate3d(0, ${(a*.3).toFixed(1)}px, 0)`)},{passive:!0})}initLiquidGlass(){document.querySelectorAll(".liquid-glass-card, .project-card-3d, .hero-finder-card, .milestone-card-refined, .pill-navbar, .quick-bar-container, .modal-content-advanced, .lightbox-dialog, .spec-tech-card, .amenity-luxury-card").forEach(t=>{let i;const r=()=>{i=t.getBoundingClientRect()},o=s=>{i||(i=t.getBoundingClientRect());const n=s.clientX-i.left,l=s.clientY-i.top,d=(n/i.width*100).toFixed(1),u=(l/i.height*100).toFixed(1);t.style.setProperty("--mouse-x",`${d}%`),t.style.setProperty("--mouse-y",`${u}%`)};t.removeEventListener("mouseenter",r),t.removeEventListener("mousemove",o),t.addEventListener("mouseenter",r),t.addEventListener("mousemove",o)})}}const x=W.getInstance(),re=Object.values(A);function ne(){const e=document.createElement("section");e.id="projects",e.className="section projects-section lux-reveal",e.innerHTML=`
    <div class="container">
      ...
      <div class="luxury-tabs-wrapper fade-in-up delay-2 mb-xl text-center">
        <button class="lux-filter-tab active" data-filter="all">
          ...
          <span class="tab-count-badge">${re.length}</span>
        </button>
  ...
  `,e.appendChild(r),e}function le(){const e=document.createElement("section");e.id="project-comparison",e.className="section project-comparison-section";const a=A[1],t=A[2],i=A[3];e.innerHTML=`
    <div class="container">
      <div class="section-header text-center mb-xl">
      ...
      <div class="spec-tabs-header flex justify-center flex-wrap gap-xs mb-lg">
        ${i.map((o,s)=>`
          <button class="spec-tab-btn ${s===0?"active":""}" data-index="${s}">
            <i class="fa-solid ${o.icon} mr-2"></i> ${o.category}
          </button>
        `).join("")}
      </div>
        ...
        ${i.map((o,s)=>`
          <div class="spec-pane ${s===0?"active":""}" id="spec-pane-${s}">
            <div class="spec-pane-header flex items-center gap-md mb-md pb-sm border-bottom">
              ...
              <div>
                <h3 class="spec-category-title">${o.category}</h3>
  ...
  `,a.appendChild(r),setTimeout(()=>{const o=a.querySelectorAll(".spec-tab-btn"),s=a.querySelectorAll(".spec-pane");o.forEach(n=>{n.addEventListener("click",()=>{o.forEach(u=>u.classList.remove("active")),s.forEach(u=>u.classList.remove("active")),n.classList.add("active");const l=n.getAttribute("data-index"),d=a.querySelector("#spec-pane-"+l);d&&d.classList.add("active")})})},0),a}function ce(){const e=document.createElement("section");e.id="location-hub",e.className="section location-hub-section";const a=[{category:"IT Parks & Employment Centers",icon:"fa-briefcase",color:"#3B82F6",items:[{name:"Hinjewadi Rajiv Gandhi IT Park (Phase 1)",time:"12 - 15 Mins",distance:"6.8 km"},{name:"Hinjewadi IT Park (Phase 2 & 3 - Quadron/Embassy)",time:"18 - 20 Mins",distance:"10.5 km"},{name:"Talawade IT Park & MIDC Pimpri",time:"20 Mins",distance:"12.0 km"},{name:"Bhumkar Chowk Commercial Tech Zone",time:"07 Mins",distance:"3.5 km"}]},{category:"Highways, Transit & Metro",icon:"fa-road",color:"#F59E0B",items:[{name:"Mumbai-Pune Expressway (NH-48 Feeder)",time:"02 Mins",distance:"1.2 km"},{name:"Mukai Chowk & Ravet Flyover",time:"04 Mins",distance:"2.0 km"},{name:"Akurdi & Dehu Road Railway Stations",time:"10 Mins",distance:"4.5 km"},{name:"Upcoming Hinjewadi - Shivajinagar Metro Line",time:"10 Mins",distance:"4.0 km"}]},{category:"Top Schools & Global Universities",icon:"fa-graduation-cap",color:"#10B981",items:[{name:"Akshara International School & Junior College",time:"03 Mins",distance:"1.5 km"},{name:"JSPM Imperial College of Engineering",time:"04 Mins",distance:"2.0 km"},{name:"Indira Institute of Management (Wakad)",time:"08 Mins",distance:"3.8 km"},{name:"Symbiosis Skills & Professional University",time:"06 Mins",distance:"2.8 km"}]},{category:"Healthcare & Retail Lifestyle",icon:"fa-hospital-user",color:"#EF4444",items:[{name:"Phoenix Mall of the Millennium (Wakad)",time:"10 Mins",distance:"4.8 km"},{name:"Lifepoint Multispecialty Hospital",time:"09 Mins",distance:"4.2 km"},{name:"Aditya Birla Memorial Hospital (Chinchwad)",time:"12 Mins",distance:"5.9 km"},{name:"Sentosa Water Park & Multi-Cuisine Resort",time:"02 Mins",distance:"Opposite"}]}];e.innerHTML=`
    <div class="container">
      ...
      <div class="grid grid-cols-2 location-grid gap-lg">
        ${a.map((i,r)=>`
          <div class="location-card" data-category-idx="${r}">
              ...
              ${i.items.map(o=>`
                <div class="landmark-item flex justify-between items-center p-sm rounded-md bg-light-subtle">
                  <div class="landmark-info">
                    <span class="landmark-name font-semibold text-navy text-sm block">${o.name}</span>
                    <span class="landmark-dist text-xs text-muted"><i class="fa-solid fa-route text-gold mr-1"></i> ${o.distance}</span>
                  </div>
  ...
  `;const i=e.querySelector(".amenities-grid-custom");t.forEach(o=>{const s=document.createElement("div");s.className="amenity-box",s.innerHTML=`
      <div class="amenity-icon-wrapper">${o.icon}</div>
      <p class="amenity-title">${o.title}</p>
    `,i.appendChild(s)});const r=document.createElement("style");return r.textContent=`
    .amenities-section {
  ...
  `,e.appendChild(r),e}function ae(){const e=document.createElement("section");e.id="emi-calculator",e.className="section emi-calculator-section",e.innerHTML=`
    <div class="container">
      <div class="section-header text-center mb-xl">
  ...
  `,e.appendChild(t),e}const F=(e,a="dynamic-schema")=>{let t=document.getElementById(a);t||(t=document.createElement("script"),t.type="application/ld+json",t.id=a,document.head.appendChild(t)),t.textContent=JSON.stringify(e)},ke=()=>({"@context":"https://schema.org","@type":"RealEstateAgent","@id":"https://haricoestates.in/#organization",name:"Harico Estates, a Joint Venture by Sentosa Developers",alternateName:["Sentosa Developers","Sentosa Group Pune","Sentosa Group","Harico Group","Harico Ventures","Harico Builders Pune","Harico Realty","Sentosa Real Estate Pune","Harico Estates Punawale","Harico Estates Kiwale","Sentosa Water Park Builders"],url:"https://haricoestates.in",logo:"https://haricoestates.in/harico_logo.png",image:"https://haricoestates.in/harico_logo.png",description:"Premier real estate developer in West Pune & PCMC with a 39-year legacy (since 1987). Builders of Harico Edge (Punawale), Harico Divaam / Diwaam (Kiwale Ravet), Harico Pride (Punawale), Sentosa Ekam, Sentosa Serene, and Sentosa Paradise.",telephone:"+91-7744009295",email:"contact@haricoestates.in",priceRange:"₹70.00 Lacs - ₹1.50 Cr",address:{"@type":"PostalAddress",streetAddress:"Harico Estates, Near Bhumkar Chowk, Mumbai-Pune Expressway",addressLocality:"Punawale, Pimpri-Chinchwad, Pune",addressRegion:"Maharashtra",postalCode:"411033",addressCountry:"IN"},hasMap:"https://www.google.com/maps/place/Harico+Estates/@18.6548239,73.7256178,17z/data=!3m1!4b1!4m6!3m5!1s0x3bc2bb9618b8c49d:0x78a3bb7fcdbe5a56!8m2!3d18.6548239!4d73.7256178!16s%2Fg%2F11ynbs8sgg",geo:{"@type":"GeoCoordinates",latitude:"18.6548239",longitude:"73.7256178"},openingHoursSpecification:[{"@type":"OpeningHoursSpecification",dayOfWeek:["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"],opens:"09:30",closes:"19:30"}],parentOrganization:{"@type":"Organization",name:"Sentosa Developers & Hospitality Group",foundingDate:"1987",description:"39 Years of Legacy in Real Estate, Hospitality (Sentosa Water Park & Resorts), and Commercial Developments across Pune and Maharashtra."},areaServed:ie.map(e=>({"@type":"Place",name:e})),knowsAbout:[...fe,...ie,"MahaRERA Regulatory Compliance","Mivan Monolithic Concrete Technology","Luxury 2 & 3 BHK Apartments in PCMC","Real Estate Investment & Rental Yield in West Pune","Hinjewadi IT Park Residential Corridors"],hasOfferCatalog:{"@type":"OfferCatalog",name:"Harico Estates & Sentosa Real Estate Portfolio",itemListElement:[{"@type":"Offer",itemOffered:{"@type":"ApartmentComplex",name:"Harico Edge",description:"2 & 3 BHK Ultra-Premium Homes in Punawale, Pune",url:"https://haricoestates.in/project/harico-edge"},priceCurrency:"INR",price:"7400000",priceSpecification:{"@type":"PriceSpecification",price:"7400000",priceCurrency:"INR",minPrice:"7400000",maxPrice:"11800000"}},{"@type":"Offer",itemOffered:{"@type":"ApartmentComplex",name:"Harico Divaam",description:"2 & 3 BHK High-Rise 24-Storey Residences in Kiwale-Ravet, Pune",url:"https://haricoestates.in/project/harico-divaam"},priceCurrency:"INR",price:"7000000",priceSpecification:{"@type":"PriceSpecification",price:"7000000",priceCurrency:"INR",minPrice:"7000000",maxPrice:"10800000"}},{"@type":"Offer",itemOffered:{"@type":"ApartmentComplex",name:"Harico Pride",description:"Spacious 2 & 3 BHK Luxury Residences in Punawale, Pune",url:"https://haricoestates.in/project/harico-pride"},priceCurrency:"INR",price:"7800000"}]},sameAs:["https://www.facebook.com/haricoestates","https://www.instagram.com/haricoestates","https://maharera.mahaonline.gov.in","https://www.google.com/maps/place/Harico+Estates/@18.6548239,73.7256178,17z/data=!3m1!4b1!4m6!3m5!1s0x3bc2bb9618b8c49d:0x78a3bb7fcdbe5a56!8m2!3d18.6548239!4d73.7256178!16s%2Fg%2F11ynbs8sgg"]}),Pe=e=>{let a=[`Sentosa ${e.title}`,`${e.title} by Sentosa Group`];return e.slug==="harico-divaam"?a=["Harico Diwaam","Harico Divaam Kiwale","Harico Diwaam Kiwale","Sentosa Harico Divaam","Sentosa Harico Diwaam","Sentosa Divaam","Sentosa Diwaam","Harico Divam","Harico Diwam","Harico Estates Divaam","Harico Estates Diwaam","Codename Divine Kiwale"]:e.slug==="harico-edge"?a=["Harico Edge Punawale","Sentosa Harico Edge","Sentosa Edge","Sentosa Edge Punawale","Harico Edge Pune","Harico Estates Edge","Harico Edge by Sentosa"]:e.slug==="harico-pride"&&(a=["Harico Pride Punawale","Sentosa Harico Pride","Sentosa Pride","Harico Estates Pride"]),{"@context":"https://schema.org","@type":"ApartmentComplex","@id":`https://haricoestates.in/project/${e.slug}#complex`,name:`${e.title} by Harico Estates`,alternateName:a,image:["https://haricoestates.in"+e.image,...(e.floorPlans||[]).map(t=>"https://haricoestates.in"+t.image)],description:e.description,url:`https://haricoestates.in/project/${e.slug}`,telephone:"+91-7744009295",keywords:e.seo?.keywords||"",address:{"@type":"PostalAddress",streetAddress:`${e.title}, ${e.location}`,addressLocality:e.location,addressRegion:"Maharashtra",addressCountry:"IN"},geo:{"@type":"GeoCoordinates",latitude:e.slug==="harico-divaam"?"18.6738":"18.6366",longitude:e.slug==="harico-divaam"?"73.7225":"73.7483"},hasMap:e.slug==="harico-divaam"?"https://www.google.com/maps?q=harico+divaam":"https://www.google.com/maps?q=harico+estates",amenityFeature:Array.isArray(e.amenities)?typeof e.amenities[0]=="string"?e.amenities.map(t=>({"@type":"LocationFeatureSpecification",name:t,value:!0})):e.amenities.flatMap(t=>t.items.map(i=>({"@type":"LocationFeatureSpecification",name:i,value:!0}))):[],numberOfAccommodationUnits:e.unitsTotal||"280+",floorSize:{"@type":"QuantitativeValue",unitCode:"FTK",minValue:"724",maxValue:"1180"},identifier:e.reraNumber||e.reraId,containedInPlace:{"@type":"Place",name:e.location},makesOffer:(e.configurations||[]).map(t=>({"@type":"Offer",name:`${t.type} at ${e.title}`,description:`${t.type} with ${t.carpet} carpet area at ${e.title}`,price:t.price,priceCurrency:"INR",availability:"https://schema.org/InStock",seller:{"@type":"RealEstateAgent",name:"Harico Estates, a Joint Venture by Sentosa Developers"}}))}},Se=e=>({"@context":"https://schema.org","@type":"Product","@id":`https://haricoestates.in/project/${e.slug}#product`,name:`${e.title} — Luxury 2 & 3 BHK Flats in ${e.location}`,image:[`https://haricoestates.in${e.image}`],description:e.description,sku:`HARICO-${e.slug.toUpperCase()}`,mpn:e.reraNumber||e.reraId,brand:{"@type":"Brand",name:"Harico Estates by Sentosa Developers"},offers:{"@type":"AggregateOffer",priceCurrency:"INR",lowPrice:e.slug==="harico-divaam"?"7000000":e.slug==="harico-edge"?"7400000":"7800000",highPrice:e.slug==="harico-divaam"?"10800000":e.slug==="harico-edge"?"11800000":"11500000",offerCount:"120",priceValidUntil:"2027-12-31",availability:"https://schema.org/InStock",url:`https://haricoestates.in/project/${e.slug}`,seller:{"@type":"Organization",name:"Harico Estates"},hasMerchantReturnPolicy:{"@type":"MerchantReturnPolicy",applicableCountry:"IN",returnPolicyCategory:"https://schema.org/MerchantReturnFiniteReturnWindow",merchantReturnDays:15,returnMethod:"https://schema.org/ReturnInStore",returnFees:"https://schema.org/FreeReturn"},shippingDetails:{"@type":"OfferShippingDetails",shippingRate:{"@type":"MonetaryAmount",value:"0",currency:"INR"},deliveryTime:{"@type":"ShippingDeliveryTime",businessDays:{"@type":"OpeningHoursSpecification",dayOfWeek:["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"]},cutoffTime:"19:30:00+05:30",handlingTime:{"@type":"QuantitativeValue",minValue:0,maxValue:1,unitCode:"DAY"},transitTime:{"@type":"QuantitativeValue",minValue:0,maxValue:1,unitCode:"DAY"}}}},aggregateRating:{"@type":"AggregateRating",ratingValue:"4.9",reviewCount:e.slug==="harico-divaam"?"148":"126",bestRating:"5",worstRating:"1"},review:[{"@type":"Review",reviewRating:{"@type":"Rating",ratingValue:"5",bestRating:"5"},author:{"@type":"Person",name:e.slug==="harico-divaam"?"Vikram Malhotra":"Aniket Kulkarni"},datePublished:"2026-02-18",reviewBody:e.slug==="harico-divaam"?"Harico Diwaam is the finest high-rise development in Kiwale Ravet. 24 storeys with stunning views of Sentosa and Sahyadri mountains. Very transparent booking process and trusted Sentosa developers.":"Booked our 3 BHK flat at Harico Edge Punawale. The layout is zero wastage, dual balconies are huge, and connectivity to Bhumkar Chowk and Hinjewadi IT Park is incredible."}]}),De=()=>({"@context":"https://schema.org","@type":"Product","@id":"https://haricoestates.in/#flagship-product",name:"Harico Estates — Ultra-Luxury 2 & 3 BHK Flats in Pune",image:["https://haricoestates.in/assets/harico-divaam-hero.jpg","https://haricoestates.in/assets/harico-edge-hero.png"],description:"Harico Estates by Sentosa Developers: Ultra-luxury 2 & 3 BHK residences at Harico Diwaam (Kiwale, Starts ₹70L*) and Harico Edge (Punawale, Starts ₹74L*). Dual private balconies, 100+ resort amenities, zero brokerage.",sku:"HARICO-ESTATES-PUNE",mpn:"PR1260002502389",brand:{"@type":"Brand",name:"Harico Estates by Sentosa Developers"},offers:{"@type":"AggregateOffer",priceCurrency:"INR",lowPrice:"7000000",highPrice:"11800000",offerCount:"240",priceValidUntil:"2027-12-31",availability:"https://schema.org/InStock",url:"https://haricoestates.in/",seller:{"@type":"Organization",name:"Harico Estates"},hasMerchantReturnPolicy:{"@type":"MerchantReturnPolicy",applicableCountry:"IN",returnPolicyCategory:"https://schema.org/MerchantReturnFiniteReturnWindow",merchantReturnDays:15,returnMethod:"https://schema.org/ReturnInStore",returnFees:"https://schema.org/FreeReturn"},shippingDetails:{"@type":"OfferShippingDetails",shippingRate:{"@type":"MonetaryAmount",value:"0",currency:"INR"},deliveryTime:{"@type":"ShippingDeliveryTime",businessDays:{"@type":"OpeningHoursSpecification",dayOfWeek:["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"]},cutoffTime:"19:30:00+05:30",handlingTime:{"@type":"QuantitativeValue",minValue:0,maxValue:1,unitCode:"DAY"},transitTime:{"@type":"QuantitativeValue",minValue:0,maxValue:1,unitCode:"DAY"}}}},aggregateRating:{"@type":"AggregateRating",ratingValue:"4.9",reviewCount:"148",bestRating:"5",worstRating:"1"},review:[{"@type":"Review",reviewRating:{"@type":"Rating",ratingValue:"5",bestRating:"5"},author:{"@type":"Person",name:"Dr. Sameer Joshi"},datePublished:"2026-02-15",reviewBody:"Purchased a 3 BHK in Harico Diwaam Kiwale. Outstanding quality of construction with Mivan shuttering and stunning unobstructed mountain views. Sentosa's 39-year heritage gives complete peace of mind."},{"@type":"Review",reviewRating:{"@type":"Rating",ratingValue:"5",bestRating:"5"},author:{"@type":"Person",name:"Rohit Verma"},datePublished:"2026-01-20",reviewBody:"Harico Edge in Punawale is easily the best investment opportunity near Hinjewadi IT Park. Zero dead space layouts, dual balconies, and top-tier amenities."}]}),Ee=e=>{let a=[];return e.slug==="harico-edge"?a=[{name:"What is the price of 2 BHK and 3 BHK flats at Harico Edge Punawale?",text:"2 BHK Smart and Premium residences at Harico Edge start from ₹74 Lacs* onwards (741 to 826 sq.ft carpet), and spacious 3 BHK luxury residences start from ₹89 Lacs* to ₹1.18 Cr* with dual balconies."},{name:"What is the MahaRERA registration number of Harico Edge?",text:"Harico Edge in Punawale is sanctioned and registered under MahaRERA No. P52100031773."},{name:"How far is Harico Edge from Hinjewadi IT Park and Phoenix Mall?",text:"Harico Edge is just 10 minutes from Phoenix Mall of the Millennium (Wakad), 2 minutes from Mumbai-Pune Expressway, and 15 minutes from Hinjewadi Rajiv Gandhi Infotech Park Phase 1."}]:e.slug==="harico-divaam"?a=[{name:"What is the starting price for 2 BHK and 3 BHK flats in Harico Divaam / Diwaam Kiwale?",text:"Harico Divaam (Harico Diwaam Kiwale) luxury residences start from ₹70.00 Lacs* onwards for 2 BHK (724 sq.ft carpet) and ₹89.90 Lacs* onwards for 3 BHK (920 sq.ft carpet), with flexible milestone payment plans and pre-approved home loans from SBI, HDFC, and ICICI."},{name:"What are the exact configurations and carpet areas in Harico Diwaam Kiwale?",text:"Harico Diwaam offers 2 BHK Smart (724 sq.ft), 2 BHK Comfort (760 sq.ft), 2 BHK Grand (848 sq.ft), 3 BHK Smart (920 sq.ft), 3 BHK Comfort (983 sq.ft), and 3 BHK Grand (1,108 sq.ft) usable carpet areas with dual private balconies."},{name:"How many floors, towers, and land acreage does Harico Diwaam have?",text:"Harico Diwaam is the tallest residential landmark in the Kiwale-Ravet corridor, featuring 5 iconic sky towers standing 24 storeys tall across an expansive 5.0-acre master development."},{name:"What is the MahaRERA registration number and target possession date for Harico Diwaam?",text:"Harico Divaam is officially approved and registered under MahaRERA No. PR1260002502389 with target possession scheduled for December 2030."},{name:"What amenities are available at Harico Diwaam Kiwale?",text:"Harico Diwaam features over 100+ resort-grade lifestyle amenities, including a 24th-floor Sky Observation Deck, infinity swimming pool, sky gymnasium, 40-seater Dolby Atmos mini-theatre, podcasting & creator studios, co-working lounges, and 12 luxury guest suites for visiting family."},{name:"Where is Harico Diwaam located and how far is it from Hinjewadi and Expressway?",text:"Harico Diwaam is located directly opposite Sentosa Water Park on the Mumbai-Pune Expressway corridor in Kiwale-Ravet. It is 2 minutes from Mukai Chowk BRTS, 5-7 minutes from Akurdi Railway Station, and 12-15 minutes from Hinjewadi Rajiv Gandhi Infotech Park."},{name:"What construction technology is being used at Harico Diwaam?",text:"Harico Diwaam is constructed using earthquake-resistant Mivan monolithic concrete technology, providing seismic Zone III compliance, superior acoustic insulation, and seamless crack-free finishes."},{name:"Who is the developer of Harico Diwaam Kiwale?",text:"Harico Diwaam is developed by Harico Estates, a Joint Venture by Sentosa Developers, a trusted real estate group with a 39-year legacy (since 1987), 20+ completed projects, and builders of Sentosa Water Park & Resorts."}]:a=[{name:"What are the key features of Harico Pride Punawale?",text:"Harico Pride offers the largest usable carpet area 2 & 3 BHK luxury homes in Punawale with rooftop infinity amenities and 3-tier smart security."},{name:"What is the MahaRERA registration for Harico Pride?",text:"Harico Pride is officially registered under MahaRERA No. P52100018471."}],{"@context":"https://schema.org","@type":"FAQPage","@id":`https://haricoestates.in/project/${e.slug}#faq`,mainEntity:a.map(t=>({"@type":"Question",name:t.name,acceptedAnswer:{"@type":"Answer",text:t.text}}))}},Ke=()=>({"@context":"https://schema.org","@type":"FAQPage","@id":"https://haricoestates.in/#faq",mainEntity:[{"@type":"Question",name:"What is the starting price for 2 BHK flats at Harico Edge Punawale?",acceptedAnswer:{"@type":"Answer",text:"Harico Edge in Punawale offers ultra-premium 2 BHK residences starting from ₹74 Lacs* and spacious 3 BHK residences starting from ₹89 Lacs* with dual balconies and 50+ amenities."}},{"@type":"Question",name:"What is the price and elevation of Harico Divaam in Kiwale Ravet?",acceptedAnswer:{"@type":"Answer",text:"Harico Divaam is the tallest residential landmark in the Kiwale-Ravet corridor, featuring 5 iconic 24-storey towers across 5 acres. 2 BHK luxury residences start from ₹70.00 Lacs* and 3 BHK from ₹89.90 Lacs* onwards directly opposite Sentosa Water Park."}},{"@type":"Question",name:"Are Harico Estates projects registered with MahaRERA?",acceptedAnswer:{"@type":"Answer",text:"Yes, 100% of Harico Estates projects are sanctioned and registered under MahaRERA: Harico Edge (P52100031773), Harico Divaam (PR1260002502389), and Harico Pride (P52100018471)."}},{"@type":"Question",name:"What is the connectivity of Harico projects to Hinjewadi IT Park and Expressway?",acceptedAnswer:{"@type":"Answer",text:"Harico projects enjoy unmatched connectivity: 2 minutes to the Mumbai-Pune Expressway & Mukai Chowk, 10 minutes to Phoenix Mall of the Millennium (Wakad), and 15-18 minutes to Hinjewadi Rajiv Gandhi Infotech Park Phase 1, 2 & 3."}},{"@type":"Question",name:"Who is the developer behind Harico Estates?",acceptedAnswer:{"@type":"Answer",text:"Harico Estates is backed by the prestigious 39-year legacy (since 1987) of Sentosa Developers, creators of Sentosa Water Park & Resorts and over 20+ delivered landmark projects across Pune."}}]}),_=(e,a,t,i)=>{const r=(s,n)=>{let l=document.querySelector(`meta[property="${s}"]`)||document.querySelector(`meta[name="${s}"]`);l||(l=document.createElement("meta"),s.startsWith("og:")?l.setAttribute("property",s):l.setAttribute("name",s),document.head.appendChild(l)),l.setAttribute("content",n)};r("description",a),r("og:title",e),r("og:description",a),r("og:image",t),r("og:url",i),r("og:type","website"),r("twitter:card","summary_large_image"),r("twitter:title",e),r("twitter:description",a),r("twitter:image",t);let o=document.querySelector('link[rel="canonical"]');o||(o=document.createElement("link"),o.setAttribute("rel","canonical"),document.head.appendChild(o)),o.setAttribute("href",i)},Ce=()=>({"@context":"https://schema.org","@type":"WebSite","@id":"https://haricoestates.in/#website",url:"https://haricoestates.in",name:"Harico Estates, a Joint Venture by Sentosa Developers",description:"Harico Estates, a Joint Venture by Sentosa Developers: Luxury 2 & 3 BHK residences in Punawale and Kiwale, Pune.",publisher:{"@id":"https://haricoestates.in/#organization"},potentialAction:{"@type":"SearchAction",target:"https://haricoestates.in/projects?q={search_term_string}","query-input":"required name=search_term_string"}}),Fe=e=>({"@context":"https://schema.org","@type":"Article","@id":`https://haricoestates.in/articles/${e.slug}#article`,headline:e.title,description:e.metaDescription,image:e.image.startsWith("http")?e.image:`https://haricoestates.in${e.image}`,datePublished:`${e.publishDate}T09:00:00+05:30`,dateModified:"2026-03-14T12:00:00+05:30",author:{"@type":"Organization",name:"Harico Estates Research & Editorial Team",url:"https://haricoestates.in"},publisher:{"@type":"Organization",name:"Harico Estates, a Joint Venture by Sentosa Developers",logo:{"@type":"ImageObject",url:"https://haricoestates.in/harico_logo.png"}},mainEntityOfPage:{"@type":"WebPage","@id":`https://haricoestates.in/articles/${e.slug}`},articleSection:e.category,keywords:e.keywords}),Be=e=>!e.faqs||e.faqs.length===0?null:{"@context":"https://schema.org","@type":"FAQPage","@id":`https://haricoestates.in/articles/${e.slug}#faq`,mainEntity:e.faqs.map(a=>({"@type":"Question",name:a.q,acceptedAnswer:{"@type":"Answer",text:a.a}}))},Re=(e,a,t)=>{const i=[{"@type":"ListItem",position:1,name:"Home",item:"https://haricoestates.in"}];return e?(i.push({"@type":"ListItem",position:2,name:"Projects",item:"https://haricoestates.in/projects"}),i.push({"@type":"ListItem",position:3,name:e.title,item:`https://haricoestates.in/project/${e.slug}`})):a?i.push({"@type":"ListItem",position:2,name:a.h1||a.title,item:`https://haricoestates.in/${a.path}`}):t&&(i.push({"@type":"ListItem",position:2,name:"Articles & Guides",item:"https://haricoestates.in/articles"}),i.push({"@type":"ListItem",position:3,name:t.title,item:`https://haricoestates.in/articles/${t.slug}`})),{"@context":"https://schema.org","@type":"BreadcrumbList",itemListElement:i}},y=(e,a,t)=>{if(F(ke(),"org-schema"),F(Ce(),"website-schema"),F(Re(e,a,t),"breadcrumb-schema"),e){F(Pe(e),"project-schema"),F(Se(e),"product-schema"),F(Ee(e),"project-faq-schema");const i=document.querySelector('meta[name="keywords"]');i&&e.seo?.keywords&&i.setAttribute("content",e.seo.keywords),_(`${e.title} | ${e.location} | Harico Estates`,e.description,"https://haricoestates.in"+e.image,"https://haricoestates.in/project/"+e.slug)}else if(a){const i=document.getElementById("project-schema");i&&i.remove();const r=document.getElementById("project-faq-schema");r&&r.remove();const o=document.getElementById("product-schema");o&&o.remove();const s=document.querySelector('meta[name="keywords"]');s&&a.metaKeywords&&s.setAttribute("content",a.metaKeywords),_(a.title,a.description||a.subtitle,"https://haricoestates.in/assets/harico-divaam-hero.jpg",`https://haricoestates.in/${a.path}`)}else if(t){const i=document.getElementById("project-schema");i&&i.remove();const r=document.getElementById("project-faq-schema");r&&r.remove();const o=document.getElementById("product-schema");o&&o.remove(),F(Fe(t),"article-schema");const s=Be(t);s&&F(s,"article-faq-schema");const n=document.querySelector('meta[name="keywords"]');n&&t.keywords&&n.setAttribute("content",t.keywords),_(`${t.title} | Harico Estates Knowledge Hub`,t.metaDescription,t.image.startsWith("http")?t.image:`https://haricoestates.in${t.image}`,`https://haricoestates.in/articles/${t.slug}`)}else{const i=document.getElementById("project-schema");i&&i.remove();const r=document.getElementById("project-faq-schema");r&&r.remove(),F(De(),"product-schema"),F(Ke(),"faq-schema"),_("Harico Estates | A Joint Venture by Sentosa Developers | Harico Diwaam & Harico Edge","Harico Estates, a Joint Venture by Sentosa Developers: Ultra-luxury 2 & 3 BHK flats at Harico Diwaam (Kiwale, Dec 2030, Starts ₹70L*, 3 BHK from ₹89.90L*) & Harico Edge (Punawale, June 2030). Call +91 7744009295.","https://haricoestates.in/harico_logo.png","https://haricoestates.in/")}};function pe(){const e=document.createElement("section");e.id="faq",e.className="section faq-section";const a=[{question:"What is Harico Estates and what is its development heritage in Pune?",answer:"<b>Harico Estates</b> is the premier residential development entity of <b>Sentosa Developers</b>, a trusted real estate and hospitality conglomerate with a <b>39-year legacy (founded in 1987)</b> across Pune, PCMC, and Maharashtra. Backed by 20+ delivered landmark developments and the iconic Sentosa Water Park & Resorts, Harico Estates is known for 100% legal title compliance, earthquake-resistant Mivan monolithic engineering, and strategic highway-adjacent developments."},{question:"What is the starting price for 2 BHK and 3 BHK flats at Harico Diwaam Kiwale?",answer:"At <b>Harico Diwaam (Harico Divaam Kiwale)</b>, luxury 2 BHK apartments start from <b>₹70.00 Lacs* Onwards</b> (724 sq.ft usable carpet area) and 3 BHK apartments start from <b>₹89.90 Lacs* Onwards</b> (920 sq.ft usable carpet area). Larger 2 BHK Comfort (760 sq.ft), 2 BHK Grand (848 sq.ft), 3 BHK Comfort (983 sq.ft), and 3 BHK Grand (1,108 sq.ft) variants are also available with flexible construction-linked payment schedules."},{question:"What is the difference between Harico Diwaam and Harico Divaam?",answer:'<b>Harico Diwaam</b> and <b>Harico Divaam</b> refer to the exact same landmark residential development situated directly opposite Sentosa Water Park in Kiwale-Ravet. "Harico Divaam" is the official spelling filed under MahaRERA registration number <b>PR1260002502389</b>, while "Harico Diwaam" is the widely used phonetic brand spelling searched by homebuyers.'},{question:"How many towers, floors, and acres make up Harico Diwaam Kiwale?",answer:"Harico Diwaam is the tallest residential development in the Kiwale-Ravet micro-market, featuring <b>5 iconic sky towers rising 24 storeys tall</b> set within an expansive <b>5.0-acre master-planned land parcel</b>."},{question:"What is the MahaRERA registration number and possession date for Harico Diwaam?",answer:"Harico Diwaam (Harico Divaam) is approved and registered under MahaRERA registration number <b>PR1260002502389</b> with target completion and possession scheduled for <b>December 2030</b>."},{question:"What 100+ resort lifestyle amenities are provided at Harico Diwaam Kiwale?",answer:"Harico Diwaam features over 100+ curated amenities across 6 lifestyle zones, including a <b>24th-floor Rooftop Sky Observation Deck</b>, infinity edge swimming pool, sky gymnasium, 40-seater Dolby Atmos private mini-theatre, podcasting and YouTube creator studio, 12 fully furnished guest suites for visiting family, business co-working lounges, tennis and badminton courts, children’s splash pool, and 3-tier security."},{question:"Where is Harico Diwaam located and how far is it from Hinjewadi & Expressway?",answer:"Harico Diwaam is positioned <b>directly opposite Sentosa Water Park</b> on the Mumbai-Pune Expressway corridor in Kiwale-Ravet (PIN: 412101). It is situated just <b>2 minutes from Mukai Chowk BRTS</b>, <b>2 minutes from the Mumbai-Pune Expressway</b>, <b>5 minutes from Akurdi Railway Station</b>, and <b>12–15 minutes from Hinjewadi Rajiv Gandhi Infotech Park Phase 1</b>."},{question:"What residential projects are developed under Harico Kiwale?",answer:"Under the <b>Harico Kiwale</b> development umbrella, the flagship project is <b>Harico Diwaam (Harico Divaam Kiwale)</b>, featuring 24-storey high-rise luxury towers across 5 acres opposite Sentosa Water Park. Harico Kiwale represents the pinnacle of high-rise engineering in the Kiwale-Ravet growth belt."},{question:"What is Harico Edge Punawale and what is its starting price and possession date?",answer:"<b>Harico Edge</b> is a luxury 22-storey residential development in Punawale (PIN: 411033) spanning 2.5 acres near Bhumkar Chowk. 2 BHK residences start from <b>₹74.00 Lacs* Onwards</b> (741 sq.ft carpet) and 3 BHK residences start from <b>₹89.00 Lacs* Onwards</b> (942 sq.ft carpet up to 1,148 sq.ft). Target possession is scheduled for <b>June 2030</b> under MahaRERA registration number <b>P52100031773</b>."},{question:"What residential projects are developed under Harico Punawale?",answer:"The <b>Harico Punawale</b> corridor comprises two flagship developments by Sentosa Developers: <b>Harico Edge</b> (MahaRERA P52100031773, June 2030 possession) and <b>Harico Pride</b> (MahaRERA P52100018471, near-possession June 2027), along with delivered Sentosa landmarks such as Sentosa Ekam and Sentosa Pride Phases 1, 2 & 3."},{question:"What is Harico Pride Punawale and when is its possession?",answer:"<b>Harico Pride</b> is an expansive residential enclave located near Bhiku Vallabh Kale School in Punawale. It offers the largest usable carpet area 2 & 3 BHK residences in Punawale (765 to 1,180 sq.ft) with starting prices from <b>₹78.00 Lacs*</b>. Target possession is <b>June 2027</b> under MahaRERA registration number <b>P52100018471</b>."},{question:"What is Mivan monolithic concrete construction and why does Harico Estates use it?",answer:"Harico Estates standardizes <b>Mivan monolithic aluminium formwork concrete casting</b> across all projects. Unlike conventional brick construction that is prone to hairline cracks and moisture seepage, Mivan casts walls and slabs simultaneously in high-grade concrete, delivering superior earthquake resistance (IS Zone III compliant), jointless water-tight walls, smooth factory-quality wall finishes, and 4%–6% more usable carpet area."},{question:"Which nationalized and private banks have approved Harico projects for home loans?",answer:"All Harico Estates developments are pre-approved by leading financial institutions including <b>State Bank of India (SBI)</b>, <b>HDFC Bank</b>, <b>ICICI Bank</b>, <b>Axis Bank</b>, <b>Bank of Baroda</b>, and <b>Kotak Mahindra Bank</b>. Competitive interest rates starting from 8.35%* p.a. and fast-track sanctions are facilitated by our in-house finance desk."},{question:"What are the usable carpet areas available across Harico Estates projects?",answer:"Harico Estates offers 2 BHK configurations from <b>724 sq.ft to 848 sq.ft</b> and 3 BHK configurations from <b>920 sq.ft to 1,180 sq.ft</b>. Every layout features zero space wastage, dual private balconies, separate dry utility balconies, and dedicated master bedroom wardrobe niches."},{question:"What are the expected rental yields and capital appreciation in Punawale and Kiwale?",answer:"Punawale and Kiwale have demonstrated consistent <b>15%–18% capital appreciation</b> over the past 3 years due to high IT professional influx from Hinjewadi and Wakad. Gross rental yields range between <b>4.2% to 4.8%</b>, with 2 BHK monthly rentals averaging ₹22,000 to ₹28,000 and 3 BHK rentals reaching ₹32,000 to ₹40,000."},{question:"What is the booking token amount and procedure for a flat in Harico Estates?",answer:"You can reserve your preferred unit with a nominal booking token amount. The construction-linked payment plan is structured according to clear MahaRERA milestones across plinth casting, individual slab completions, internal plastering, and final handover."},{question:"Are all Harico Estates projects free from legal encumbrances and clear title approved?",answer:"Yes, 100% of Harico Estates developments have clear, marketable, and unencumbered legal titles vetted by top corporate legal counsels, with sanctioned building layouts and commencement certificates (CC) approved by PCMC and MahaRERA."},{question:"How do I schedule a priority VIP site visit and visit the sample flat?",answer:"You can schedule a priority VIP site visit by calling our direct sales desk at <b>+91 7744009295</b> or messaging on WhatsApp. Our site sales galleries are open all 7 days from 9:30 AM to 7:30 PM with fully furnished show apartments available for viewing."}],t={"@context":"https://schema.org","@type":"FAQPage",mainEntity:a.map(r=>({"@type":"Question",name:r.question,acceptedAnswer:{"@type":"Answer",text:r.answer.replace(/<[^>]*>?/gm,"")}}))};F(t,"faq-schema"),e.innerHTML=`
    <div class="container">
      ...
      <div class="faq-accordion-container max-w-900 mx-auto">
        ${a.map((r,o)=>`
          <div class="faq-item ${o===0?"active":""}">
            <button class="faq-question-btn flex justify-between items-center w-full" aria-expanded="${o===0?"true":"false"}">
              <span class="faq-q-text">${r.question}</span>
              <span class="faq-icon"><i class="fa-solid fa-chevron-down"></i></span>
            </button>
            <div class="faq-answer-pane" style="${o===0?"max-height: 250px;":"max-height: 0;"}">
              <p class="faq-a-text">${r.answer}</p>
            </div>
          </div>
        `).join("")}
      </div>
  ...
  `,e.appendChild(i),setTimeout(()=>{const r=e.querySelectorAll(".faq-item");r.forEach(o=>{const s=o.querySelector(".faq-question-btn"),n=o.querySelector(".faq-answer-pane");s?.addEventListener("click",()=>{const l=o.classList.contains("active");r.forEach(d=>{d.classList.remove("active");const u=d.querySelector(".faq-answer-pane");u&&(u.style.maxHeight="0")}),!l&&n&&(o.classList.add("active"),n.style.maxHeight=n.scrollHeight+30+"px")})})},0),e}async function me(e){const a="propsmartrealty@gmail.com",t=new Date().toLocaleString("en-IN",{timeZone:"Asia/Kolkata"}),i=e.sourceUrl||window.location.href,r={_subject:`🚨 New Real Estate Lead: ${e.name} - ${e.project||"Harico Estates"}`,_replyto:e.email||"propsmartrealty@gmail.com",_template:"table",_captcha:"false","Lead Name":e.name,"Phone Number":e.phone,"Email Address":e.email||"Not Provided (Phone Preferred)","Target Project":e.project||"Harico Estates General Enquiry","Configuration / Requirement":e.requirement||"2 & 3 BHK Luxury Residences","Interest Type":e.interestType||"Direct Website Lead","Preferred Site Visit Slot":e.timeSlot||"Immediate / Flexible","Buyer Notes / Message":e.message||"Direct developer consultation requested","Landing Page URL":i,"Received At (IST)":`${t} IST`};try{fetch(`https://formsubmit.co/ajax/${a}`,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(r)}).catch(o=>console.warn("[LeadDispatcher] Email background dispatch:",o))}catch(o){console.warn("[LeadDispatcher] Failed sending email:",o)}try{fetch("/api/lead",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...e,timestamp:t,recipient:a})}).catch(()=>{})}catch{}try{typeof window.gtag=="function"&&(window.gtag("event","conversion",{send_to:"AW-17430583486/2oseCKuOodYcEL6xxvdA"}),window.gtag("event","generate_lead",{send_to:"AW-17430583486",event_category:"RealEstateLead",event_label:e.project||"Harico Estates",value:1}))}catch(o){console.warn("[LeadDispatcher] Google Ads conversion dispatch error:",o)}return{success:!0}}function P(){const e=document.createElement("section");e.id="contact",e.className="section contact-section lux-reveal",e.innerHTML=`
    <div class="container">
      <div class="section-header text-center mb-xl">
  ...
  `,e.appendChild(a),setTimeout(()=>{e.querySelector("#contact-hub-form")?.addEventListener("submit",i=>{i.preventDefault();const r=e.querySelector("#contact-name")?.value,o=e.querySelector("#contact-phone")?.value,s=e.querySelector("#contact-project")?.value,n=e.querySelector("#contact-slot")?.value,l=e.querySelector("#contact-msg")?.value;me({name:r,phone:o,project:s,timeSlot:n,message:l,interestType:"VIP Site Visit Booking"});let d=`*VIP Site Visit Booking Request* 🏛️
...
_Lead dispatched to propsmartrealty@gmail.com_`,window.open(`https://wa.me/917744009295?text=${encodeURIComponent(d)}`,"_blank"),i.target.reset()})},0),e}function Me(){const e=document.createElement("footer");e.className="footer-section",e.innerHTML=`
  ...
  `;const a=e.querySelector(".close-btn-adv"),t=e.querySelector("#advEnquireForm"),i=e.querySelectorAll(".project-chip"),r=e.querySelector("#advSubmitBtn"),o=r.querySelector(".btn-text"),s=r.querySelector(".btn-loader");let n="Harico Diwaam (Kiwale)";i.forEach(p=>{p.addEventListener("click",()=>{i.forEach(w=>w.classList.remove("active")),p.classList.add("active"),n=p.dataset.project||"Harico Estates"})});const l=()=>{e.classList.add("hidden")};a.addEventListener("click",l),e.addEventListener("click",p=>{p.target===e&&l()}),t.addEventListener("submit",p=>{p.preventDefault();const w=e.querySelector("#adv-name"),b=e.querySelector("#adv-phone"),S=e.querySelector("#adv-email"),T=e.querySelector("#adv-config"),v=e.querySelector("#adv-intent");o.classList.add("hidden"),s.classList.remove("hidden"),r.disabled=!0;const f={name:w.value.trim(),phone:b.value.trim(),email:S.value.trim(),project:n,requirement:T.value,interestType:v.value};me(f);const D="917744009295";let H=`*VIP Priority Enquiry — Harico Estates* 🏡
...
_Please send the official brochure, cost sheet, and schedule our VIP site visit._`;const B=`https://wa.me/${D}?text=${encodeURIComponent(H)}`;setTimeout(()=>{window.open(B,"_blank"),l(),t.reset(),o.classList.remove("hidden"),s.classList.add("hidden"),r.disabled=!1},600)}),window.showEnquireModal=p=>{p&&i.forEach(w=>{const b=w.dataset.project||"";(b.toLowerCase().includes(p.toLowerCase())||p.toLowerCase().includes(b.toLowerCase()))&&(i.forEach(S=>S.classList.remove("active")),w.classList.add("active"),n=b)}),e.classList.remove("hidden")};let d=!1;document.addEventListener("mouseleave",p=>{p.clientY<=0&&!d&&e.classList.contains("hidden")&&!sessionStorage.getItem("exit_modal_shown")&&(d=!0,sessionStorage.setItem("exit_modal_shown","true"),window.showEnquireModal())});const u=document.createElement("style");return u.textContent=`
  ...
  `,e.appendChild(a),window.openFloorPlanLightbox=(o,s,n,l)=>{const d=e.querySelector("#lightbox-img"),u=e.querySelector("#lightbox-plan-title"),p=e.querySelector("#lightbox-plan-subtitle"),w=e.querySelector("#lightbox-wa-btn");d&&(d.src=o),u&&(u.textContent=s),p&&(p.textContent=n);const b=`Hi, I am interested in the *${s}* (${n}) at *${l}*. Please share the high-resolution architectural plan PDF and detailed cost sheet.`;w&&(w.href=`https://wa.me/917744009295?text=${encodeURIComponent(b)}`),e.classList.remove("hidden")};const t=e.querySelector(".lightbox-close-btn"),i=e.querySelector(".lightbox-backdrop"),r=e.querySelector(".lightbox-enquire-btn");return t?.addEventListener("click",()=>e.classList.add("hidden")),i?.addEventListener("click",()=>e.classList.add("hidden")),r?.addEventListener("click",()=>{e.classList.add("hidden");const o=e.querySelector("#lightbox-plan-title")?.textContent||"Floor Plan";window.showEnquireModal&&window.showEnquireModal(`Enquiry for ${o}`)}),e}function Le(){const e=document.createElement("button");e.id="back-to-top",e.className="back-to-top-btn hidden",e.setAttribute("aria-label","Back to top"),e.innerHTML=`
  ...
  `;const a=e.querySelector(".progress-ring-circle"),i=2*Math.PI*20;a&&(a.style.strokeDasharray=`${i} ${i}`,a.style.strokeDashoffset=`${i}`),window.addEventListener("scroll",()=>{const o=window.scrollY,s=document.documentElement.scrollHeight-window.innerHeight;if(o>350?e.classList.remove("hidden"):e.classList.add("hidden"),s>0&&a){const n=o/s,l=i-n*i;a.style.strokeDashoffset=`${l}`}}),e.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});const r=document.createElement("style");return r.textContent=`
    .back-to-top-btn {
      position: fixed;
      bottom: 25px;
      right: 25px;
  ...
  `,e.appendChild(r),e}function Te(){const e=document.createElement("aside");e.className="mobile-quick-action-bar",e.setAttribute("aria-label","Quick Contact"),e.innerHTML=`
  ...
  `,e.appendChild(a),e}function qe(e){const a=document.createElement("div");a.className="quick-info-bar",a.innerHTML=`
    ...
    <div class="table-responsive">
      <table class="config-table">
        ...
        <tbody>
          ${t.length>0?t.map(r=>`
            <tr>
                <td><span class="unit-type">${r.type}</span></td>
                <td><span class="unit-area">${r.carpet}</span></td>
                <td>
                    <a href="https://wa.me/917744009295?text=Hi, I am interested in ${encodeURIComponent(r.type)} at ${encodeURIComponent(e.title)}. Please share the price breakup." target="_blank" class="btn-price-request">
                        <span class="icon">
  ...
  `;const i=qe(e),r=document.createElement("div");r.className="pd-content-wrapper section";const o=document.createElement("div");o.className="container";const s=document.createElement("div");s.className="about-section mb-xl",s.id="about";const n=(e.highlights||[]).map(m=>`
  ...
  `;let v="";e.masterLayout&&(v+=`
    ...
    `);const f=document.createElement("div");f.className="section container",f.id="floor-plans",f.innerHTML=v;const D=ee(e.specifications),H=ae(),B=document.createElement("div");B.className="section pd-location",B.id="location";const G=(e.connectivity||[]).map(m=>`
  ...
  `,a.appendChild(t),a.appendChild(i);const k=document.createElement("div");k.className="pd-sections-wrapper",o.appendChild(s),k.appendChild(o),k.appendChild(f);const I=document.createElement("div");I.className="section container",I.appendChild(l),I.appendChild(d),k.appendChild(I),k.appendChild(D),k.appendChild(p),k.appendChild(H),k.appendChild(B),k.appendChild(O),k.appendChild(q),a.appendChild(k),a.appendChild(N);const U=document.createElement("style");return U.textContent=`
    .pd-hero {
      height: 65vh;
      min-height: 520px;
      width: 100%;
  ...
  `,e.appendChild(a),e}function We(e){const a=document.createElement("section");a.className="section programmatic-hub-section lux-reveal";const t=Object.values(A);let i=t;e.targetLocation&&(i=t.filter(s=>s.location.toLowerCase().includes(e.targetLocation.toLowerCase()))),i.length===0&&(i=t),a.innerHTML=`
  ...
  `;const r=a.querySelector(".prog-cards-grid");r&&i.forEach(s=>{r.appendChild(se(s))});const o=document.createElement("style");return o.textContent=`
  ...
  `,e}function Ne(e){const a=document.createElement("article");a.className="section article-detail-section lux-reveal";const t=te.filter(i=>i.slug!==e.slug).slice(0,3);return a.innerHTML=`
