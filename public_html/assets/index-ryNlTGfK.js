(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=t(o);fetch(o.href,r)}})();function ge(){const e=document.createElement("header");e.className="header-pill-wrapper",window.addEventListener("scroll",()=>{window.scrollY>25?e.classList.add("scrolled"):e.classList.remove("scrolled");const t=["home","builder-legacy","projects","project-comparison","specifications","location-hub","amenities","emi-calculator","faq","contact"];let i="";t.forEach(o=>{const r=document.getElementById(o);if(r){const s=r.offsetTop;window.scrollY>=s-160&&(i=o)}}),document.querySelectorAll(".pill-nav-link").forEach(o=>{o.classList.remove("active");const r=o.getAttribute("data-target");(r===i||i==="builder-legacy"&&r==="home")&&o.classList.add("active")})}),e.innerHTML=`
  ...
  `,e.appendChild(t),setTimeout(()=>{const i=e.querySelectorAll(".legacy-filter-btn"),o=e.querySelectorAll(".milestone-card-refined");i.forEach(r=>{r.addEventListener("click",()=>{i.forEach(l=>l.classList.remove("active")),r.classList.add("active");const s=r.getAttribute("data-era");o.forEach(l=>{s==="all"||l.classList.contains(`era-${s}`)?l.style.display="flex":l.style.display="none"})})})},0),e}function re(e){const a=document.createElement("article");a.className="project-card-3d card-3d-tilt";const t=e.slug||e.id;return a.onclick=i=>{const o=i.target;o.closest("button")||o.closest("a")||o.closest(".card-rera-interactive")||h.navigate(`/project/${t}`)},a.innerHTML=`
  ...
  `,setTimeout(()=>{a.querySelectorAll(".btn-explore-trigger, .btn-explore-action").forEach(o=>{o.addEventListener("click",r=>{r.stopPropagation();const s=o.getAttribute("data-slug");s&&h.navigate(`/project/${s}`)})})},0),a}const ve=`
  .project-card-3d {
    background: #FFFFFF;
    border-radius: 20px;
    overflow: hidden;
...
`;class W{static instance;observer=null;isTouchDevice=!1;cursorGlow=null;targetMouseX=0;targetMouseY=0;currentMouseX=0;currentMouseY=0;isCursorGlowActive=!1;constructor(){this.isTouchDevice="ontouchstart"in window||navigator.maxTouchPoints>0}static getInstance(){return W.instance||(W.instance=new W),W.instance}init(){this.setupScrollObserver(),this.initCounters(),this.isTouchDevice||(this.init3DTilt(),this.initMagneticButtons(),this.initCursorGlow(),this.initScrollParallax())}initCursorGlow(){if(this.cursorGlow||this.isTouchDevice)return;this.cursorGlow=document.createElement("div"),this.cursorGlow.id="cursor-glow-spotlight",this.cursorGlow.className="cursor-glow-spotlight",document.body.appendChild(this.cursorGlow),window.addEventListener("mousemove",t=>{this.targetMouseX=t.clientX,this.targetMouseY=t.clientY,!this.isCursorGlowActive&&this.cursorGlow&&(this.cursorGlow.style.opacity="1",this.isCursorGlowActive=!0)}),document.addEventListener("mouseleave",()=>{this.cursorGlow&&(this.cursorGlow.style.opacity="0",this.isCursorGlowActive=!1)});const a=()=>{this.isCursorGlowActive&&this.cursorGlow&&(this.currentMouseX+=(this.targetMouseX-this.currentMouseX)*.12,this.currentMouseY+=(this.targetMouseY-this.currentMouseY)*.12,this.cursorGlow.style.transform=`translate3d(${this.currentMouseX-200}px, ${this.currentMouseY-200}px, 0)`),requestAnimationFrame(a)};requestAnimationFrame(a)}setupScrollObserver(){this.observer&&this.observer.disconnect();const a={root:null,rootMargin:"0px 0px -50px 0px",threshold:.1};this.observer=new IntersectionObserver(t=>{t.forEach(i=>{if(i.isIntersecting){const o=i.target;o.classList.add("lux-in-view"),o.querySelectorAll("[data-counter-target]").forEach(s=>this.animateCounter(s)),this.observer?.unobserve(o)}})},a),document.querySelectorAll(".lux-reveal, .lux-stagger, .section, .milestone-card-refined, .project-card-3d").forEach(t=>{this.observer?.observe(t)})}initCounters(){document.querySelectorAll("[data-counter-target]").forEach(a=>{const t=a.getBoundingClientRect();t.top<window.innerHeight&&t.bottom>=0&&this.animateCounter(a)})}animateCounter(a){if(a.dataset.counterAnimated==="true")return;a.dataset.counterAnimated="true";const t=a.dataset.counterTarget||"0",i=parseFloat(t.replace(/[^0-9.]/g,"")),o=a.dataset.counterPrefix||"",r=a.dataset.counterSuffix||"",s=2200,l=performance.now(),n=c=>{const u=c-l,p=Math.min(u/s,1),f=p===1?1:1-Math.pow(2,-10*p),b=Math.floor(f*i);a.textContent=`${o}${b.toLocaleString("en-IN")}${r}`,p<1?requestAnimationFrame(n):a.textContent=`${o}${i.toLocaleString("en-IN")}${r}`};requestAnimationFrame(n)}init3DTilt(){document.querySelectorAll(".card-3d-tilt, .milestone-card-refined").forEach(t=>{let i;const o=()=>{i=t.getBoundingClientRect(),t.style.transition="transform 0.12s ease-out, box-shadow 0.3s ease"},r=l=>{i||(i=t.getBoundingClientRect());const n=l.clientX-i.left,c=l.clientY-i.top,u=n/i.width*100,p=c/i.height*100,f=n/i.width-.5,b=c/i.height-.5,P=f*14,L=-b*14;t.style.transform=`perspective(1000px) rotateX(${L.toFixed(2)}deg) rotateY(${P.toFixed(2)}deg) scale3d(1.02, 1.02, 1.02)`;const v=t.querySelector(".card-glare-overlay");v&&(v.style.opacity="1",v.style.background=`radial-gradient(circle 280px at ${u}% ${p}%, rgba(255, 255, 255, 0.3), rgba(212, 175, 55, 0.16) 40%, transparent 80%)`)},s=()=>{t.style.transition="transform 0.6s cubic-bezier(0.16, 1, 0.3, 1), box-shadow 0.6s ease",t.style.transform="perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1)";const l=t.querySelector(".card-glare-overlay");l&&(l.style.opacity="0")};t.removeEventListener("mouseenter",o),t.removeEventListener("mousemove",r),t.removeEventListener("mouseleave",s),t.addEventListener("mouseenter",o),t.addEventListener("mousemove",r),t.addEventListener("mouseleave",s)})}initMagneticButtons(){document.querySelectorAll(".btn-magnetic, .btn-primary, .btn-whatsapp").forEach(t=>{t.addEventListener("mousemove",i=>{const o=t.getBoundingClientRect(),r=i.clientX-o.left-o.width/2,s=i.clientY-o.top-o.height/2;t.style.transform=`translate(${r*.2}px, ${s*.2}px)`}),t.addEventListener("mouseleave",()=>{t.style.transform="translate(0px, 0px)"})})}initScrollParallax(){window.addEventListener("scroll",()=>{const a=window.scrollY,t=document.querySelector(".hero-bg-media");t&&a<window.innerHeight&&(t.style.transform=`translate3d(0, ${(a*.3).toFixed(1)}px, 0)`)},{passive:!0})}}const H=W.getInstance(),ie=Object.values(M);function se(){const e=document.createElement("section");e.id="projects",e.className="section projects-section lux-reveal",e.innerHTML=`
    <div class="container">
      ...
      <div class="luxury-tabs-wrapper fade-in-up delay-2 mb-xl text-center">
        <button class="lux-filter-tab active" data-filter="all">
          ...
          <span class="tab-count-badge">${ie.length}</span>
        </button>
  ...
  `;const a=e.querySelector(".projects-grid-modern"),t=e.querySelectorAll(".lux-filter-tab");function i(r){a.innerHTML="";const s=ie.filter(l=>r==="all"?!0:r==="ongoing"?l.status==="Ongoing":r==="punawale"?l.location.toLowerCase().includes("punawale"):r==="kiwale"?l.location.toLowerCase().includes("kiwale"):!0);if(s.length===0){a.innerHTML='<div class="text-center col-span-full py-xl text-muted">No projects found matching this filter.</div>';return}s.forEach((l,n)=>{const c=re(l);c.style.opacity="0",c.style.transform="translateY(25px)",c.style.transition=`opacity 0.6s cubic-bezier(0.16, 1, 0.3, 1) ${n*.1}s, transform 0.6s cubic-bezier(0.16, 1, 0.3, 1) ${n*.1}s`,a.appendChild(c),requestAnimationFrame(()=>{c.style.opacity="1",c.style.transform="translateY(0)"})}),setTimeout(()=>{H.init3DTilt()},50)}i("all"),t.forEach(r=>{r.addEventListener("click",()=>{t.forEach(l=>l.classList.remove("active")),r.classList.add("active");const s=r.getAttribute("data-filter")||"all";i(s)})});const o=document.createElement("style");return o.textContent=`
    ${ve}
  ...
  `,e.appendChild(o),e}function ne(){const e=document.createElement("section");e.id="project-comparison",e.className="section project-comparison-section";const a=M[1],t=M[2],i=M[3];e.innerHTML=`
    <div class="container">
      <div class="section-header text-center mb-xl">
  ...
  `,e.appendChild(a),setTimeout(()=>{e.querySelector("#contact-hub-form")?.addEventListener("submit",i=>{i.preventDefault();const o=e.querySelector("#contact-name")?.value,r=e.querySelector("#contact-phone")?.value,s=e.querySelector("#contact-project")?.value,l=e.querySelector("#contact-slot")?.value,n=e.querySelector("#contact-msg")?.value;pe({name:o,phone:r,project:s,timeSlot:l,message:n,interestType:"VIP Site Visit Booking"});let c=`*VIP Site Visit Booking Request* 🏛️
...
_Lead dispatched to propsmartrealty@gmail.com_`,window.open(`https://wa.me/917744009295?text=${encodeURIComponent(c)}`,"_blank"),i.target.reset()})},0),e}function Ee(){const e=document.createElement("footer");e.className="footer-section",e.innerHTML=`
  ...
  `,e.appendChild(a),e}function me(){const e=document.createElement("div");e.id="enquire-modal",e.className="modal-overlay hidden",e.innerHTML=`
  ...
  `;const a=e.querySelector(".close-btn-adv"),t=e.querySelector("#advEnquireForm"),i=e.querySelectorAll(".project-chip"),o=e.querySelector("#advSubmitBtn"),r=o.querySelector(".btn-text"),s=o.querySelector(".btn-loader");let l="Harico Divaam (Kiwale)";i.forEach(p=>{p.addEventListener("click",()=>{i.forEach(f=>f.classList.remove("active")),p.classList.add("active"),l=p.dataset.project||"Harico Estates"})});const n=()=>{e.classList.add("hidden")};a.addEventListener("click",n),e.addEventListener("click",p=>{p.target===e&&n()}),t.addEventListener("submit",p=>{p.preventDefault();const f=e.querySelector("#adv-name"),b=e.querySelector("#adv-phone"),P=e.querySelector("#adv-email"),L=e.querySelector("#adv-config"),v=e.querySelector("#adv-intent");r.classList.add("hidden"),s.classList.remove("hidden"),o.disabled=!0;const w={name:f.value.trim(),phone:b.value.trim(),email:P.value.trim(),project:l,requirement:L.value,interestType:v.value};pe(w);const S="917744009295";let x=`*VIP Priority Enquiry — Harico Estates* 🏡

`;x+=`*Project:* ${w.project}
`,x+=`*Name:* ${w.name}
`,x+=`*Phone:* ${w.phone}
`,w.email&&(x+=`*Email:* ${w.email}
`),x+=`*Configuration:* ${w.requirement}
`,x+=`*Requirement:* ${w.interestType}
`,x+=`
_Please send the official brochure, cost sheet, and schedule our VIP site visit._`;const F=`https://wa.me/${S}?text=${encodeURIComponent(x)}`;setTimeout(()=>{window.open(F,"_blank"),n(),t.reset(),r.classList.remove("hidden"),s.classList.add("hidden"),o.disabled=!1},600)}),window.showEnquireModal=p=>{p&&i.forEach(f=>{const b=f.dataset.project||"";(b.toLowerCase().includes(p.toLowerCase())||p.toLowerCase().includes(b.toLowerCase()))&&(i.forEach(P=>P.classList.remove("active")),f.classList.add("active"),l=b)}),e.classList.remove("hidden")};let c=!1;document.addEventListener("mouseleave",p=>{p.clientY<=0&&!c&&e.classList.contains("hidden")&&!sessionStorage.getItem("exit_modal_shown")&&(c=!0,sessionStorage.setItem("exit_modal_shown","true"),window.showEnquireModal())});const u=document.createElement("style");return u.textContent=`
    .modal-overlay {
      position: fixed;
  ...
  `,e.appendChild(u),e}function Ke(){const e=document.createElement("div");e.id="floorplan-lightbox",e.className="floorplan-lightbox-overlay hidden",e.innerHTML=`
  ...
  `,e.appendChild(o),e}function Fe(){const e=document.createElement("aside");e.className="mobile-quick-action-bar",e.setAttribute("aria-label","Quick Contact"),e.innerHTML=`
  ...
  `,e.appendChild(a),e}function Be(e){const a=document.createElement("div");a.className="quick-info-bar",a.innerHTML=`
  ...
  `,a.appendChild(i),a}function Me(e){const a=document.createElement("div");a.className="project-details-page";const t=document.createElement("div");t.className="pd-hero",t.style.backgroundImage=`url('${e.image}')`,t.innerHTML=`
  ...
  `;const i=Be(e),o=document.createElement("div");o.className="pd-content-wrapper section";const r=document.createElement("div");r.className="container";const s=document.createElement("div");s.className="about-section mb-xl",s.id="about";const l=(e.highlights||[]).map(m=>`
  ...
  `;let v="";e.masterLayout&&(v+=`
    ...
    `);const w=document.createElement("div");w.className="section container",w.id="floor-plans",w.innerHTML=v;const S=ee(e.specifications),x=ae(),F=document.createElement("div");F.className="section pd-location",F.id="location";const G=(e.connectivity||[]).map(m=>`
  ...
  `;const N=me(),O=document.createElement("div");O.className="section container",O.innerHTML=`
  ...
  `,a.appendChild(t),a.appendChild(i);const y=document.createElement("div");y.className="pd-sections-wrapper",r.appendChild(s),y.appendChild(r),y.appendChild(w);const q=document.createElement("div");q.className="section container",q.appendChild(n),q.appendChild(c),y.appendChild(q),y.appendChild(S),y.appendChild(p),y.appendChild(x),y.appendChild(F),y.appendChild(O),y.appendChild(T),a.appendChild(y),a.appendChild(N);const Q=document.createElement("style");return Q.textContent=`
    .pd-hero {
      height: 65vh;
      min-height: 520px;
      width: 100%;
  ...
  `,e.appendChild(a),e}function qe(e){const a=document.createElement("section");a.className="section programmatic-hub-section lux-reveal";const t=Object.values(M);let i=t;e.targetLocation&&(i=t.filter(s=>s.location.toLowerCase().includes(e.targetLocation.toLowerCase()))),i.length===0&&(i=t),a.innerHTML=`
  ...
  `;const o=a.querySelector(".prog-cards-grid");o&&i.forEach(s=>{o.appendChild(re(s))});const r=document.createElement("style");return r.textContent=`
