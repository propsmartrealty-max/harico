(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=t(o);fetch(o.href,r)}})();function we(){const e=document.createElement("header");e.className="header-pill-wrapper",window.addEventListener("scroll",()=>{window.scrollY>25?e.classList.add("scrolled"):e.classList.remove("scrolled");const t=["home","builder-legacy","projects","project-comparison","specifications","location-hub","amenities","emi-calculator","faq","contact"];let i="";t.forEach(o=>{const r=document.getElementById(o);if(r){const s=r.offsetTop;window.scrollY>=s-160&&(i=o)}}),document.querySelectorAll(".pill-nav-link").forEach(o=>{o.classList.remove("active");const r=o.getAttribute("data-target");(r===i||i==="builder-legacy"&&r==="home")&&o.classList.add("active")})}),e.innerHTML=`
  ...
  `,e.appendChild(t),setTimeout(()=>{const i=e.querySelectorAll(".legacy-filter-btn"),o=e.querySelectorAll(".milestone-card-refined");i.forEach(r=>{r.addEventListener("click",()=>{i.forEach(n=>n.classList.remove("active")),r.classList.add("active");const s=r.getAttribute("data-era");o.forEach(n=>{s==="all"||n.classList.contains(`era-${s}`)?n.style.display="flex":n.style.display="none"})})})},0),e}function se(e){const a=document.createElement("article");a.className="project-card-3d card-3d-tilt liquid-glass-card";const t=e.slug||e.id;return a.onclick=i=>{const o=i.target;o.closest("button")||o.closest("a")||o.closest(".card-rera-interactive")||h.navigate(`/project/${t}`)},a.innerHTML=`
    ...
    <div class="card-media-wrapper">
      ...
      <div class="card-top-badges flex justify-between items-center w-full">
        <div class="flex items-center gap-xs">
          <div class="status-badge-capsule liquid-glass-pill ${e.status.toLowerCase()}">
  ...
  `,setTimeout(()=>{a.querySelectorAll(".btn-explore-trigger, .btn-explore-action").forEach(o=>{o.addEventListener("click",r=>{r.stopPropagation();const s=o.getAttribute("data-slug");s&&h.navigate(`/project/${s}`)})})},0),a}const xe=`
  .project-card-3d {
    background: #FFFFFF;
    border-radius: 20px;
    overflow: hidden;
...
`;class ${static instance;observer=null;isTouchDevice=!1;cursorGlow=null;targetMouseX=0;targetMouseY=0;currentMouseX=0;currentMouseY=0;isCursorGlowActive=!1;constructor(){this.isTouchDevice="ontouchstart"in window||navigator.maxTouchPoints>0}static getInstance(){return $.instance||($.instance=new $),$.instance}init(){this.setupScrollObserver(),this.initCounters(),this.isTouchDevice||(this.init3DTilt(),this.initMagneticButtons(),this.initCursorGlow(),this.initScrollParallax(),this.initLiquidGlass())}initCursorGlow(){if(this.cursorGlow||this.isTouchDevice)return;this.cursorGlow=document.createElement("div"),this.cursorGlow.id="cursor-glow-spotlight",this.cursorGlow.className="cursor-glow-spotlight",document.body.appendChild(this.cursorGlow),window.addEventListener("mousemove",t=>{this.targetMouseX=t.clientX,this.targetMouseY=t.clientY,!this.isCursorGlowActive&&this.cursorGlow&&(this.cursorGlow.style.opacity="1",this.isCursorGlowActive=!0)}),document.addEventListener("mouseleave",()=>{this.cursorGlow&&(this.cursorGlow.style.opacity="0",this.isCursorGlowActive=!1)});const a=()=>{this.isCursorGlowActive&&this.cursorGlow&&(this.currentMouseX+=(this.targetMouseX-this.currentMouseX)*.12,this.currentMouseY+=(this.targetMouseY-this.currentMouseY)*.12,this.cursorGlow.style.transform=`translate3d(${this.currentMouseX-200}px, ${this.currentMouseY-200}px, 0)`),requestAnimationFrame(a)};requestAnimationFrame(a)}setupScrollObserver(){this.observer&&this.observer.disconnect();const a={root:null,rootMargin:"0px 0px -50px 0px",threshold:.1};this.observer=new IntersectionObserver(t=>{t.forEach(i=>{if(i.isIntersecting){const o=i.target;o.classList.add("lux-in-view"),o.querySelectorAll("[data-counter-target]").forEach(s=>this.animateCounter(s)),this.observer?.unobserve(o)}})},a),document.querySelectorAll(".lux-reveal, .lux-stagger, .section, .milestone-card-refined, .project-card-3d").forEach(t=>{this.observer?.observe(t)})}initCounters(){document.querySelectorAll("[data-counter-target]").forEach(a=>{const t=a.getBoundingClientRect();t.top<window.innerHeight&&t.bottom>=0&&this.animateCounter(a)})}animateCounter(a){if(a.dataset.counterAnimated==="true")return;a.dataset.counterAnimated="true";const t=a.dataset.counterTarget||"0",i=parseFloat(t.replace(/[^0-9.]/g,"")),o=a.dataset.counterPrefix||"",r=a.dataset.counterSuffix||"",s=2200,n=performance.now(),l=d=>{const u=d-n,p=Math.min(u/s,1),w=p===1?1:1-Math.pow(2,-10*p),b=Math.floor(w*i);a.textContent=`${o}${b.toLocaleString("en-IN")}${r}`,p<1?requestAnimationFrame(l):a.textContent=`${o}${i.toLocaleString("en-IN")}${r}`};requestAnimationFrame(l)}init3DTilt(){document.querySelectorAll(".card-3d-tilt, .milestone-card-refined").forEach(t=>{let i;const o=()=>{i=t.getBoundingClientRect(),t.style.transition="transform 0.12s ease-out, box-shadow 0.3s ease"},r=n=>{i||(i=t.getBoundingClientRect());const l=n.clientX-i.left,d=n.clientY-i.top,u=l/i.width*100,p=d/i.height*100,w=l/i.width-.5,b=d/i.height-.5,D=w*14,q=-b*14;t.style.transform=`perspective(1000px) rotateX(${q.toFixed(2)}deg) rotateY(${D.toFixed(2)}deg) scale3d(1.02, 1.02, 1.02)`;const y=t.querySelector(".card-glare-overlay");y&&(y.style.opacity="1",y.style.background=`radial-gradient(circle 280px at ${u}% ${p}%, rgba(255, 255, 255, 0.3), rgba(212, 175, 55, 0.16) 40%, transparent 80%)`)},s=()=>{t.style.transition="transform 0.6s cubic-bezier(0.16, 1, 0.3, 1), box-shadow 0.6s ease",t.style.transform="perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1)";const n=t.querySelector(".card-glare-overlay");n&&(n.style.opacity="0")};t.removeEventListener("mouseenter",o),t.removeEventListener("mousemove",r),t.removeEventListener("mouseleave",s),t.addEventListener("mouseenter",o),t.addEventListener("mousemove",r),t.addEventListener("mouseleave",s)})}initMagneticButtons(){document.querySelectorAll(".btn-magnetic, .btn-primary, .btn-whatsapp").forEach(t=>{t.addEventListener("mousemove",i=>{const o=t.getBoundingClientRect(),r=i.clientX-o.left-o.width/2,s=i.clientY-o.top-o.height/2;t.style.transform=`translate(${r*.2}px, ${s*.2}px)`}),t.addEventListener("mouseleave",()=>{t.style.transform="translate(0px, 0px)"})})}initScrollParallax(){window.addEventListener("scroll",()=>{const a=window.scrollY,t=document.querySelector(".hero-bg-media");t&&a<window.innerHeight&&(t.style.transform=`translate3d(0, ${(a*.3).toFixed(1)}px, 0)`)},{passive:!0})}initLiquidGlass(){document.querySelectorAll(".liquid-glass-card, .project-card-3d, .hero-finder-card, .milestone-card-refined, .pill-navbar, .quick-bar-container, .modal-content-advanced, .lightbox-dialog, .spec-tech-card, .amenity-luxury-card").forEach(t=>{let i;const o=()=>{i=t.getBoundingClientRect()},r=s=>{i||(i=t.getBoundingClientRect());const n=s.clientX-i.left,l=s.clientY-i.top,d=(n/i.width*100).toFixed(1),u=(l/i.height*100).toFixed(1);t.style.setProperty("--mouse-x",`${d}%`),t.style.setProperty("--mouse-y",`${u}%`)};t.removeEventListener("mouseenter",o),t.removeEventListener("mousemove",r),t.addEventListener("mouseenter",o),t.addEventListener("mousemove",r)})}}const v=$.getInstance(),oe=Object.values(A);function ne(){const e=document.createElement("section");e.id="projects",e.className="section projects-section lux-reveal",e.innerHTML=`
    <div class="container">
  ...
  `;const a=e.querySelector(".projects-grid-modern"),t=e.querySelectorAll(".lux-filter-tab");function i(r){a.innerHTML="";const s=oe.filter(n=>r==="all"?!0:r==="ongoing"?n.status==="Ongoing":r==="punawale"?n.location.toLowerCase().includes("punawale"):r==="kiwale"?n.location.toLowerCase().includes("kiwale"):!0);if(s.length===0){a.innerHTML='<div class="text-center col-span-full py-xl text-muted">No projects found matching this filter.</div>';return}s.forEach((n,l)=>{const d=se(n);d.style.opacity="0",d.style.transform="translateY(25px)",d.style.transition=`opacity 0.6s cubic-bezier(0.16, 1, 0.3, 1) ${l*.1}s, transform 0.6s cubic-bezier(0.16, 1, 0.3, 1) ${l*.1}s`,a.appendChild(d),requestAnimationFrame(()=>{d.style.opacity="1",d.style.transform="translateY(0)"})}),setTimeout(()=>{v.init3DTilt()},50)}i("all"),t.forEach(r=>{r.addEventListener("click",()=>{t.forEach(n=>n.classList.remove("active")),r.classList.add("active");const s=r.getAttribute("data-filter")||"all";i(s)})});const o=document.createElement("style");return o.textContent=`
    ${xe}
  ...
  `,e.appendChild(i),setTimeout(()=>{const o=e.querySelectorAll(".faq-item");o.forEach(r=>{const s=r.querySelector(".faq-question-btn"),n=r.querySelector(".faq-answer-pane");s?.addEventListener("click",()=>{const l=r.classList.contains("active");o.forEach(d=>{d.classList.remove("active");const u=d.querySelector(".faq-answer-pane");u&&(u.style.maxHeight="0")}),!l&&n&&(r.classList.add("active"),n.style.maxHeight=n.scrollHeight+30+"px")})})},0),e}async function me(e){const a="propsmartrealty@gmail.com",t=new Date().toLocaleString("en-IN",{timeZone:"Asia/Kolkata"}),i=e.sourceUrl||window.location.href,o={_subject:`🚨 New Real Estate Lead: ${e.name} - ${e.project||"Harico Estates"}`,_replyto:e.email||"propsmartrealty@gmail.com",_template:"table",_captcha:"false","Lead Name":e.name,"Phone Number":e.phone,"Email Address":e.email||"Not Provided (Phone Preferred)","Target Project":e.project||"Harico Estates General Enquiry","Configuration / Requirement":e.requirement||"2 & 3 BHK Luxury Residences","Interest Type":e.interestType||"Direct Website Lead","Preferred Site Visit Slot":e.timeSlot||"Immediate / Flexible","Buyer Notes / Message":e.message||"Direct developer consultation requested","Landing Page URL":i,"Received At (IST)":`${t} IST`};try{fetch(`https://formsubmit.co/ajax/${a}`,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(o)}).catch(r=>console.warn("[LeadDispatcher] Email background dispatch:",r))}catch(r){console.warn("[LeadDispatcher] Failed sending email:",r)}try{fetch("/api/lead",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...e,timestamp:t,recipient:a})}).catch(()=>{})}catch{}try{typeof window.gtag=="function"&&(window.gtag("event","conversion",{send_to:"AW-17430583486/2oseCKuOodYcEL6xxvdA"}),window.gtag("event","generate_lead",{send_to:"AW-17430583486",event_category:"RealEstateLead",event_label:e.project||"Harico Estates",value:1}))}catch(r){console.warn("[LeadDispatcher] Google Ads conversion dispatch error:",r)}return{success:!0}}function P(){const e=document.createElement("section");e.id="contact",e.className="section contact-section lux-reveal",e.innerHTML=`
    <div class="container">
      <div class="section-header text-center mb-xl">
  ...
  `,e.appendChild(a),setTimeout(()=>{e.querySelector("#contact-hub-form")?.addEventListener("submit",i=>{i.preventDefault();const o=e.querySelector("#contact-name")?.value,r=e.querySelector("#contact-phone")?.value,s=e.querySelector("#contact-project")?.value,n=e.querySelector("#contact-slot")?.value,l=e.querySelector("#contact-msg")?.value;me({name:o,phone:r,project:s,timeSlot:n,message:l,interestType:"VIP Site Visit Booking"});let d=`*VIP Site Visit Booking Request* 🏛️
...
`,l&&(d+=`*Requirements:* ${l}
`),d+=`
_Lead dispatched to propsmartrealty@gmail.com_`,window.open(`https://wa.me/917744009295?text=${encodeURIComponent(d)}`,"_blank"),i.target.reset()})},0),e}function Me(){const e=document.createElement("footer");e.className="footer-section",e.innerHTML=`
    <div class="container">
  ...
  `;const a=e.querySelector(".close-btn-adv"),t=e.querySelector("#advEnquireForm"),i=e.querySelectorAll(".project-chip"),o=e.querySelector("#advSubmitBtn"),r=o.querySelector(".btn-text"),s=o.querySelector(".btn-loader");let n="Harico Diwaam (Kiwale)";i.forEach(p=>{p.addEventListener("click",()=>{i.forEach(w=>w.classList.remove("active")),p.classList.add("active"),n=p.dataset.project||"Harico Estates"})});const l=()=>{e.classList.add("hidden")};a.addEventListener("click",l),e.addEventListener("click",p=>{p.target===e&&l()}),t.addEventListener("submit",p=>{p.preventDefault();const w=e.querySelector("#adv-name"),b=e.querySelector("#adv-phone"),D=e.querySelector("#adv-email"),q=e.querySelector("#adv-config"),y=e.querySelector("#adv-intent");r.classList.add("hidden"),s.classList.remove("hidden"),o.disabled=!0;const f={name:w.value.trim(),phone:b.value.trim(),email:D.value.trim(),project:n,requirement:q.value,interestType:y.value};me(f);const S="917744009295";let H=`*VIP Priority Enquiry — Harico Estates* 🏡
...
_Please send the official brochure, cost sheet, and schedule our VIP site visit._`;const R=`https://wa.me/${S}?text=${encodeURIComponent(H)}`;setTimeout(()=>{window.open(R,"_blank"),l(),t.reset(),r.classList.remove("hidden"),s.classList.add("hidden"),o.disabled=!1},600)}),window.showEnquireModal=p=>{p&&i.forEach(w=>{const b=w.dataset.project||"";(b.toLowerCase().includes(p.toLowerCase())||p.toLowerCase().includes(b.toLowerCase()))&&(i.forEach(D=>D.classList.remove("active")),w.classList.add("active"),n=b)}),e.classList.remove("hidden")};let d=!1;document.addEventListener("mouseleave",p=>{p.clientY<=0&&!d&&e.classList.contains("hidden")&&!sessionStorage.getItem("exit_modal_shown")&&(d=!0,sessionStorage.setItem("exit_modal_shown","true"),window.showEnquireModal())});const u=document.createElement("style");return u.textContent=`
  ...
  `,e.appendChild(u),e}function Ae(){const e=document.createElement("div");e.id="floorplan-lightbox",e.className="floorplan-lightbox-overlay hidden",e.innerHTML=`
  ...
  `,e.appendChild(o),e}function qe(){const e=document.createElement("aside");e.className="mobile-quick-action-bar",e.setAttribute("aria-label","Quick Contact"),e.innerHTML=`
  ...
  `,a.appendChild(t),a}function Ie(e){const a=document.createElement("div");a.className="config-section";const t=e.configurations||[];a.innerHTML=`
  ...
  `,a.appendChild(i),a}function je(e){const a=document.createElement("div");a.className="project-details-page";const t=document.createElement("div");t.className="pd-hero",t.style.backgroundImage=`url('${e.image}')`,t.innerHTML=`
  ...
  `;const i=Le(e),o=document.createElement("div");o.className="pd-content-wrapper section";const r=document.createElement("div");r.className="container";const s=document.createElement("div");s.className="about-section mb-xl",s.id="about";const n=(e.highlights||[]).map(m=>`
  ...
  `;const l=Ie(e);l.id="pricing";const d=document.createElement("div");d.className="bank-partners-section mt-xl p-lg rounded-lg bg-white border text-center";const u=e.bankPartners||["State Bank of India","HDFC Bank","ICICI Bank","Axis Bank","Bank of Baroda"];d.innerHTML=`
  ...
  `;let D="";e.amenities&&e.amenities.length>0&&typeof e.amenities[0]!="string"?D=e.amenities.map(m=>`
  ...
  `;let y="";e.masterLayout&&(y+=`
    ...
    `),e.floorPlans&&e.floorPlans.length>0&&(y+=`
        <div class="mb-xl">
    ...
    `);const f=document.createElement("div");f.className="section container",f.id="floor-plans",f.innerHTML=y;const S=ee(e.specifications),H=ae(),R=document.createElement("div");R.className="section pd-location",R.id="location";const G=(e.connectivity||[]).map(m=>`
  ...
  `;const O=ue(),N=document.createElement("div");N.className="section container",N.innerHTML=`
  ...
  `,a.appendChild(t),a.appendChild(i);const k=document.createElement("div");k.className="pd-sections-wrapper",r.appendChild(s),k.appendChild(r),k.appendChild(f);const I=document.createElement("div");I.className="section container",I.appendChild(l),I.appendChild(d),k.appendChild(I),k.appendChild(S),k.appendChild(p),k.appendChild(H),k.appendChild(R),k.appendChild(N),k.appendChild(L),a.appendChild(k),a.appendChild(O);const Q=document.createElement("style");return Q.textContent=`
    .pd-hero {
      height: 65vh;
      min-height: 520px;
      width: 100%;
  ...
  `,a.appendChild(r),a}const te=[{slug:"harico-estates-overview",title:"Harico Estates Pune: Developer Profile, Sentosa Legacy & Master Portfolio Guide",subtitle:"Everything homebuyers and investors need to know about Harico Estates, Sentosa Developers’ 39-year track record, and landmark projects in Punawale and Kiwale.",metaDescription:"Complete guide to Harico Estates Pune by Sentosa Developers. Explore ongoing projects (Harico Diwaam, Harico Edge, Harico Pride), 39-year legacy, and 100% MahaRERA transparency.",keywords:"Harico Estates, Harico Estates Pune, Sentosa Developers Pune, Sentosa Harico, Harico Group, Harico Punawale, Harico Kiwale, Harico Diwaam, Harico Edge, Harico Pride, Real Estate Developer West Pune, हरिको इस्टेट्स पुणे",category:"Developer Profile",readTime:"7 min read",publishDate:"2026-03-01",author:"Harico Estates Research Desk",image:"/assets/harico-edge-hero.png",summary:"Harico Estates represents the modern residential development arm of Sentosa Developers, a trusted real estate and hospitality group with 39+ years of engineering excellence in Pune. This comprehensive profile covers corporate heritage, design philosophy, and flagship residential portfolios.",keyTakeaways:["Backed by Sentosa Developers with a 39-year legacy (founded in 1987) and 20+ delivered landmarks across Pune.","100% MahaRERA registered developments: Harico Diwaam (PR1260002502389), Harico Edge (P52100031773), and Harico Pride (P52100018471).","Pioneering Mivan monolithic concrete engineering for crack-resistant, seismic-safe high-rise homes.","Prime strategic locations: Punawale (near Bhumkar Chowk) and Kiwale (opposite Sentosa Water Park) within 2 minutes of the Mumbai-Pune Expressway."],contentHtml:`
    ...
    `,faqs:[{q:"Who is the promoter behind Harico Estates?",a:"Harico Estates is developed in venture with Sentosa Developers, a prestigious real estate and hospitality group with a 39-year legacy (since 1987) across Pune and PCMC."},{q:"Where are Harico Estates projects located?",a:"Harico Estates has active developments in Punawale (Harico Edge & Harico Pride near Bhumkar Chowk) and Kiwale (Harico Diwaam directly opposite Sentosa Water Park)."},{q:"What is the customer care and sales helpline for Harico Estates?",a:"You can reach the direct Harico Estates sales desk at +91 7744009295 or email contact@haricoestates.in."}]},{slug:"harico-diwaam-kiwale-buyer-guide",title:"Harico Diwaam Kiwale: Complete 2026 Buyer Guide — Floor Plans, Pricing, Amenities & MahaRERA",subtitle:"The most comprehensive buyer guide for Harico Diwaam (Harico Divaam Kiwale) — Pune's iconic 24-storey sky towers opposite Sentosa Water Park, starting ₹70.00 Lacs*.",metaDescription:"Complete 2026 buyer guide for Harico Diwaam Kiwale (Harico Divaam). Explore 2 & 3 BHK floor plans (724–1108 sq.ft), pricing from ₹70 Lacs*, 100+ amenities, MahaRERA PR1260002502389, loan options, ROI, and Dec 2030 possession timeline.",keywords:"Harico Diwaam, Harico Divaam, Harico Diwaam Kiwale, Harico Divaam Kiwale, Sentosa Diwaam, Sentosa Divaam, Harico Diwaam Price, Harico Diwaam Floor Plan, Harico Diwaam Brochure, Flats opposite Sentosa Water Park, 2 BHK in Kiwale, 3 BHK in Kiwale, Tallest Towers Kiwale, हरिको दिवाम किवाळे, हॅरिको दिवाम, Harico Diwaam MahaRERA, Harico Diwaam Possession 2030",category:"Project Deep Dive",readTime:"18 min read",publishDate:"2026-03-05",author:"Harico Estates Architectural Team",image:"/assets/harico-divaam-hero.jpg",summary:"Harico Diwaam (also known as Harico Divaam Kiwale) is the tallest residential high-rise landmark in the Kiwale-Ravet corridor. Rising 24 storeys across 5 acres with 5 sky towers and 100+ resort amenities, it sets a new benchmark for luxury living in West Pune.",keyTakeaways:["Kiwale's tallest residential sky towers: 5 iconic towers standing 24 storeys tall across 5.0 acres.","Attractive entry pricing: 2 BHK Smart starting at ₹70.00 Lacs* onwards; 3 BHK Smart starting at ₹89.90 Lacs* onwards.","Diverse carpet areas: 2 BHK (724 to 848 sq.ft) and 3 BHK (920 to 1,108 sq.ft) with dual private balconies.","Over 100 resort lifestyle amenities including a 24th-floor Sky Observation Deck, infinity pool, 40-seater mini theatre, and 12 luxury guest suites.","Approved under MahaRERA No. PR1260002502389 with target possession in December 2030.","Pre-approved construction-linked loans from SBI, HDFC Bank, Axis Bank, and ICICI Bank.","Mivan aluminium formwork construction ensures zero-maintenance walls, earthquake-resistant RCC structure, and faster delivery timelines."],contentHtml:`
    ...
    `,faqs:[{q:"What is the difference between Harico Diwaam and Harico Divaam?",a:'Both refer to the exact same landmark residential development in Kiwale opposite Sentosa Water Park. "Harico Divaam" is the MahaRERA registered spelling (Reg. No. PR1260002502389), while "Harico Diwaam" is the widely recognized brand and commercial spelling used across marketing materials.'},{q:"What is the starting price for Harico Diwaam Kiwale in 2026?",a:"2 BHK apartments start from ₹70.00 Lacs* onwards (724 sq.ft), and 3 BHK apartments start from ₹89.90 Lacs* onwards (920 sq.ft). Prices are exclusive of car parking, stamp duty, registration, and GST."},{q:"How can I download the official Harico Diwaam brochure and floor plans?",a:"You can download the brochure, detailed floor plans, and cost sheets directly via the enquiry portal on this website or by contacting our sales desk on WhatsApp at +91 7744009295. E-brochures are sent within 30 minutes of request."},{q:"What is the MahaRERA registration number for Harico Diwaam?",a:"Harico Divaam (Harico Diwaam) is MahaRERA registered under number PR1260002502389. You can verify this at maharera.mahaonline.gov.in by searching the RERA number directly."},{q:"When is possession expected for Harico Diwaam Kiwale?",a:"The committed possession date per MahaRERA filings is December 2030. The project uses Mivan aluminium formwork technology which ensures faster floor-by-floor construction cycles, supporting on-time delivery."},{q:"Is Harico Diwaam Kiwale a good investment in 2026?",a:"Yes — Kiwale has delivered 13–18% capital appreciation CAGR over 2019–2024. With current pre-launch prices 18–22% below comparable ready-possession addresses in Wakad/Baner, Harico Diwaam offers a strong value entry. Rental yield for 2 BHK stands at 4.2%–5.0% and for 3 BHK at 4.5%–5.2%."},{q:"Which banks have pre-approved home loans for Harico Diwaam?",a:"SBI, HDFC Bank, ICICI Bank, and Axis Bank have pre-approved Harico Diwaam, enabling faster loan processing in 3–5 working days. EMIs for ₹70 Lacs over 20 years range from ₹60,800–₹62,200/month depending on bank and rate."},{q:"What is Mivan construction and why is it used in Harico Diwaam?",a:"Mivan Aluminium Formwork is an advanced construction system where walls, slabs, columns, and beams are poured as a single monolithic RCC unit. Benefits include zero-crack walls (no replastering needed), superior earthquake resistance, faster delivery (5–7 days per floor vs. 21 days for brick), and IGBC green-certified waste reduction of 35%."},{q:"How many towers are in Harico Diwaam and how tall are they?",a:"Harico Diwaam consists of 5 sky towers, each standing 24 storeys tall. The towers are spread across a 5-acre integrated lifestyle campus in Kiwale, making it the tallest residential complex in the Kiwale-Ravet corridor."},{q:"What are the top amenities at Harico Diwaam Kiwale?",a:"Key amenities include: 24th-Floor Sky Observation Deck with panoramic Sahyadri views, 12 luxury guest suites for visiting family, a Creator Studio (podcast/YouTube recording room), 40-seater Dolby Atmos mini-theatre, infinity pool, dedicated sports complex, Wellness Spa, Planet Kids Zone, and a rooftop barbecue deck."},{q:"Does Harico Diwaam have covered car parking?",a:"Yes, all apartments at Harico Diwaam are allotted dedicated car parking — covered stilt parking for ground-level units and podium-level multilevel mechanised parking for upper floor apartments. Parking is allotted as per the Agreement for Sale."},{q:"How far is Harico Diwaam from Hinjewadi IT Park?",a:"Harico Diwaam Kiwale is approximately 7 km / 12 minutes from Hinjewadi IT Park Phase 1 via the expressway service road. Phase 2 &amp; Phase 3 (Maan) are 10–14 km away, comfortably covered in 18–22 minutes during normal traffic conditions."}]},{slug:"harico-kiwale-real-estate-investment",title:"Why Kiwale Ravet is Pune’s #1 Real Estate Growth Corridor: Harico Kiwale Guide",subtitle:"Infrastructure boom, Mumbai-Pune Expressway connectivity, Akurdi Station access, and why Harico Kiwale properties are delivering 15%+ capital growth.",metaDescription:"Discover why Kiwale Ravet is West Pune’s top real estate investment hub. Explore expressway connectivity, BRTS corridors, price trends, and Harico Kiwale developments.",keywords:"Harico Kiwale, Kiwale Real Estate, Flats in Kiwale Ravet, Kiwale Property Price, Mukai Chowk Flats, Flats opposite Sentosa Water Park, Kiwale Pune Investment, Harico Estates Kiwale, किवाळे रियल इस्टेट पुणे",category:"Market Intelligence",readTime:"6 min read",publishDate:"2026-03-08",author:"Harico Estates Market Intelligence Desk",image:"/assets/harico-divaam-composite.jpg",summary:"Kiwale has emerged from a quiet PCMC suburb into West Pune’s most strategic transit-oriented residential hub. Backed by Mukai Chowk BRTS, Mumbai-Pune Expressway flyovers, and premier educational institutes, Kiwale offers the ideal blend of affordability and exponential appreciation.",keyTakeaways:["Unmatched highway connectivity: Direct entry to the Mumbai-Pune Expressway and Katraj-Dehu Road bypass.","Rapid multimodal transit: 2 minutes to Mukai Chowk BRTS terminal and 5 minutes to Akurdi Railway Station.","High educational hub density: Proximity to Symbiosis Skills University, D.Y. Patil Akurdi, and JSPM.","Substantial price appreciation: 15%–18% capital growth over the past 36 months, with 2 BHK prices starting from ₹70.00 Lacs*."],contentHtml:`
    ...
    `,faqs:[{q:"Is Punawale more expensive than Kiwale?",a:"Punawale prices average ₹6,800–₹7,600/sq.ft due to its direct border with Wakad. Kiwale averages ₹6,200–₹7,000/sq.ft, offering a slightly more accessible entry point starting at ₹70.00 Lacs*."},{q:"Which area has better expressway connectivity: Punawale or Kiwale?",a:"Both offer 2-minute access to the Mumbai-Pune Expressway. Kiwale has direct expressway frontage opposite Sentosa Water Park, while Punawale connects via the Punawale underpass near Bhumkar Chowk."}]},{slug:"harico-diwaam-amenities-deep-dive",title:"Harico Diwaam Amenities Deep Dive: Sky Deck, Creator Studio, 12 Guest Suites & 100+ Lifestyle Features",subtitle:"Explore every amenity at Harico Diwaam Kiwale — from the 24th-floor Sky Observation Deck to Dolby Atmos cinema, Wellness Spa, and India's first Creator Studio inside a residential complex.",metaDescription:"Detailed breakdown of 100+ amenities at Harico Diwaam Kiwale: 24th-floor Sky Deck, 12 luxury guest suites, Creator Studio, 40-seat Dolby Atmos mini-theatre, infinity pool, sports complex, and rooftop barbecue.",keywords:"Harico Diwaam Amenities, Harico Divaam Amenities, Sky Deck Kiwale, Creator Studio Residential, Dolby Atmos Mini Theatre Pune, 12 Guest Suites, Harico Diwaam Infinity Pool, Sentosa Diwaam Amenities, Luxury Flats Kiwale",category:"Lifestyle & Amenities",readTime:"12 min read",publishDate:"2026-04-10",author:"Harico Estates Lifestyle Team",image:"/assets/harico-divaam-hero.jpg",summary:"Harico Diwaam Kiwale sets an unprecedented benchmark in residential amenities in West Pune — 100+ curated resort and lifestyle facilities across 6 themed zones, from a glass-floor Sky Deck on the 24th floor to India's first residential Creator Studio for content creation and podcasting.",keyTakeaways:["24th-floor Sky Observation Deck with glass-floor lookout and Sahyadri mountain panoramas.","India's first residential Creator Studio — soundproof podcast booth + YouTube production studio + 1 Gbps fiber.","12 fully furnished luxury guest suites for visiting family — bookable for up to 7 nights at no cost.","40-seater Dolby Atmos mini-theatre with 4K laser projection and reclining cinema seating.","Infinity pool, wellness spa with jacuzzi & sauna, Planet Kids Zone, and rooftop barbecue party deck.","100+ amenities curated across 6 themed zones: Sky, Wellness, Kids, Sports, Entertainment, Business."],contentHtml:`
    ...
    `,faqs:[{q:"What is the Sky Observation Deck at Harico Diwaam?",a:"The 24th-Floor Sky Observation Deck is a panoramic open-air terrace featuring a glass-floor lookout panel, high-powered telescopes, a sunset meditation pavilion, and social seating for 60+ residents with 360° views of the Sahyadri mountains and Sentosa Water Park."},{q:"Does Harico Diwaam have a swimming pool?",a:"Yes, Harico Diwaam features a 25-metre resort-style infinity pool with panoramic hill views, a separate children's wading area, pool cabanas, and heated water during winter. The pool operates from 6 AM to 10 PM daily."},{q:"What is the Creator Studio at Harico Diwaam?",a:"The Creator Studio is a professionally equipped media production facility inside the residential campus — including a soundproof podcast booth, YouTube/Reels studio with green screen and ring lights, and dedicated 1-Gbps symmetric fiber. It is the first such facility in any residential project in Kiwale."},{q:"How many guest suites does Harico Diwaam have?",a:"Harico Diwaam has 12 fully furnished, air-conditioned luxury guest suites available for booking by residents for visiting family and friends. Suites can be booked for up to 7 consecutive nights via the resident app, at no additional cost to the resident."},{q:"Is there a mini theatre at Harico Diwaam?",a:"Yes — the 40-seater Dolby Atmos mini-theatre at Harico Diwaam features stadium-terraced reclining luxury cinema seats, a 4K laser projector (Christie MIRAGE), and Dolby Atmos 7.1.4 surround sound. The theatre is bookable for private screenings, presentations, and events."},{q:"How many amenities does Harico Diwaam Kiwale have?",a:"Harico Diwaam offers 100+ curated lifestyle and resort amenities spread across 6 themed zones: Sky Zone (24th floor deck), Wellness Zone (spa, pool, sauna), Entertainment Zone (cinema, BBQ deck, gaming), Sports Zone (turf, courts, gym), Kids Zone (play areas, learning lab), and Business Zone (boardroom, co-working, library)."}]},{slug:"harico-diwaam-investment-analysis-2026",title:"Harico Diwaam Kiwale Investment Analysis 2026: ROI, Rental Yield & Capital Appreciation Forecast",subtitle:"Why investors are choosing Harico Diwaam Kiwale over Wakad and Baner. Rental yield of 4.5%–5.2%, 12–15% capital appreciation CAGR forecast, and Kiwale's position as Pune's fastest-growing real estate micro-market.",metaDescription:"Harico Diwaam Kiwale investment analysis 2026: ROI, rental yield 4.5%–5.2%, 12–15% CAGR capital appreciation, pre-launch price advantage of 18–22% below Wakad. Why Kiwale is Pune's top investment corridor.",keywords:"Harico Diwaam Investment, Harico Diwaam ROI, Kiwale Real Estate Investment 2026, Harico Diwaam Rental Yield, Kiwale Property Appreciation, Flats Kiwale Investment, Harico Diwaam Price Growth, Sentosa Diwaam Returns",category:"Investment Analysis",readTime:"14 min read",publishDate:"2026-05-15",author:"Harico Estates Research & Advisory",image:"/assets/harico-divaam-hero.jpg",summary:"Harico Diwaam Kiwale at pre-launch prices of ₹70 Lacs* for a 2 BHK represents one of the highest-conviction investment opportunities in West Pune. This analysis covers rental yields, capital appreciation CAGR, Kiwale infrastructure catalysts, and a 5-year return projection for buyers entering today.",keyTakeaways:["Kiwale has delivered 13–18% CAGR capital appreciation over 2019–2024.","Rental yield: 4.2%–5.0% for 2 BHK; 4.5%–5.2% for 3 BHK (higher than Wakad, Baner, and Balewadi).","Pre-launch entry at Harico Diwaam is 18–22% below equivalent ready-possession pricing in Wakad and Baner.","Metro Phase 3 Hinjewadi-Shivajinagar alignment (under construction) passes within 3 km of Kiwale — a major value catalyst.","Sentosa Developers: 14 projects delivered on schedule across Pune since 2013.","5-year projected return on ₹70 Lacs investment: ₹1.25–1.40 Cr (capital) + ₹10–12 Lacs cumulative rent after loan cost offset."],contentHtml:`
    ...
    `,faqs:[{q:"Is Harico Diwaam Kiwale a good investment in 2026?",a:"Yes — Harico Diwaam offers pre-launch pricing 18–22% below comparable ready-possession addresses in Wakad and Baner, a gross rental yield of 4.2–5.2% (highest in West Pune), and a 60–78% projected capital appreciation by 2031. It is backed by MahaRERA registration PR1260002502389 and a developer with 14 on-time project deliveries."},{q:"What is the rental yield for Harico Diwaam Kiwale?",a:"2 BHK apartments in Kiwale currently yield ₹18,000–₹22,000/month in rent (gross yield: 4.2%–5.0%). 3 BHK achieves ₹24,000–₹30,000/month (yield: 4.5%–5.2%). These yields are higher than comparable micro-markets like Wakad (3.2%–3.8%) and Baner (3.0%–3.5%)."},{q:"How much will Harico Diwaam price increase by possession in 2030?",a:"Based on 12–15% CAGR aligned with Kiwale-Ravet historical appreciation, a 2 BHK purchased at ₹70 Lacs in 2026 is projected to reach ₹1.12–1.25 Cr by 2030–31, representing a 60–78% gain on the entry price."},{q:"Does Kiwale have metro connectivity?",a:"The Hinjewadi–Shivajinagar Metro Phase 3 line is currently under construction, with a proposed station near Mukai Chowk — approximately 0.8 km from Harico Diwaam. Metro connectivity is projected to be operational by 2028, historically triggering 15–25% price premiums for adjacent properties."},{q:"What is the price per square foot at Harico Diwaam vs Wakad?",a:"Harico Diwaam is priced at ₹9,600–₹10,200/sqft — 18–22% below Wakad's ₹11,500–₹13,200/sqft range. This price gap is expected to close as infrastructure milestones (metro, IT park expansion, expressway widening) materialise."}]},{slug:"harico-diwaam-vs-other-kiwale-projects",title:"Harico Diwaam vs Other Kiwale & Ravet Projects: Honest Comparison Guide 2026",subtitle:"How does Harico Diwaam stack up against other residential projects in Kiwale, Ravet, and Punawale? Compare height, amenities, pricing, MahaRERA status, and developer track record.",metaDescription:"Honest comparison of Harico Diwaam vs other Kiwale and Ravet residential projects in 2026. Compare 24-storey towers, 100+ amenities, starting price ₹70 Lacs, MahaRERA, construction quality, and developer reliability.",keywords:"Harico Diwaam vs Kiwale Projects, Best Flats Kiwale 2026, Harico Divaam Comparison, Top Projects Ravet Kiwale, Flats opposite Sentosa Water Park Comparison, Best Project Mukai Chowk, Kiwale Residential Comparison",category:"Market Comparison",readTime:"10 min read",publishDate:"2026-06-01",author:"Harico Estates Market Research Team",image:"/assets/harico-divaam-hero.jpg",summary:"A transparent head-to-head comparison of Harico Diwaam against other residential projects in Kiwale, Ravet, and Punawale. We assess 8 key parameters: height, amenities, price, MahaRERA status, construction quality, location, developer track record, and ROI outlook.",keyTakeaways:["Harico Diwaam is the tallest residential project in Kiwale — 24 storeys vs. 7–14 storeys for comparable developments.","100+ amenities vs. 15–30 amenities offered by most competing Kiwale-Ravet projects.","Pre-launch pricing at ₹9,600–₹10,200/sqft — 15–20% below ready-possession comps in the same micro-market.","Mivan aluminium formwork construction (used in 0 other projects in Kiwale) ensures superior structural quality.","MahaRERA registered with PR1260002502389 — verifiable and RERA-compliant.","Sentosa Developers: 14 delivered projects on-time across Pune vs. peers with 2–5 deliveries."],contentHtml:`
    ...
    `,faqs:[{q:"Is Harico Diwaam the tallest building in Kiwale?",a:"Yes — Harico Diwaam (Harico Divaam) is the tallest residential project in the Kiwale-Ravet corridor at 24 storeys across 5 sky towers. Competing projects in the area typically range from 7 to 14 storeys."},{q:"How does Harico Diwaam compare to other Kiwale flats in terms of amenities?",a:"Harico Diwaam offers 100+ amenities across 6 themed zones (Sky, Wellness, Entertainment, Sports, Kids, Business). Comparable Kiwale projects typically offer 15–30 amenities with no sky deck, guest suites, or creator studio."},{q:"Is Mivan construction better than conventional construction?",a:"Yes, for several reasons: Mivan delivers monolithic RCC walls with no internal brick filling — eliminating cracks permanently. No replastering needed (saving ₹1.5–2.5 Lacs over 10 years). Superior earthquake resistance (Zone III certified). Faster construction cycles of 5–7 days per floor vs. 21+ days for conventional brick methods."},{q:"How does Harico Diwaam pricing compare to Wakad and Baner?",a:"Harico Diwaam is priced at ₹9,600–₹10,200/sqft — 18–22% below Wakad's ₹11,500–₹13,200/sqft range. This price gap, combined with superior height, amenities, and metro upside, makes Harico Diwaam the highest-value proposition in the West Pune corridor."}]}];function Ge(){const e=document.createElement("section");return e.className="section articles-hub-section lux-reveal",e.innerHTML=`
    <div class="container py-xl">
  ...
  `,e}function Oe(e){const a=document.createElement("article");a.className="section article-detail-section lux-reveal";const t=te.filter(i=>i.slug!==e.slug).slice(0,3);return a.innerHTML=`
