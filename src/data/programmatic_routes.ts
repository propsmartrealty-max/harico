...
export const programmaticRoutes: ProgrammaticRouteConfig[] = [
  ...
  // 4. Exact-Match Keyword Landing Pages for Search Hardening
  {
    ...
    subtitle: 'Pre-launch updates, launch price offers & possession schedules for Harico Divaam Kiwale (Dec 2030) and Harico Edge Punawale (June 2030). Starts ₹70.00 Lacs* (3 BHK from ₹89.90 Lacs*).',
  ...
  },
  {
    ...
    eyebrow: 'Signature Sky Landmark',
    subtitle: 'Official floor plans (724–1108 sq.ft), brochure PDF download, and price sheets for Harico Diwaam (Harico Divaam Kiwale). MahaRERA PR1260002502389.',
