...
export const programmaticRoutes: ProgrammaticRouteConfig[] = [
  ...
  },
  {
    ...
    subtitle: 'Discover Harico Diwaam, the tallest 24-storey high-rise development in Kiwale-Ravet directly opposite Sentosa Water Park, starting from ₹70.00 Lacs* (3 BHK from ₹89.90 Lacs* onwards).',
  ...
  },
  {
    ...
    description: 'Harico Diwaam offers 2 BHK Smart, Comfort, Prime, and Grand configurations in Kiwale. Spread across 5 acres with 5 iconic towers, residents enjoy private mini-theatres, box cricket turfs, and resort-grade pools.',
    targetLocation: 'Kiwale',
    targetBhk: '2 BHK',
    metaKeywords: 'Harico Kiwale 2 BHK, Harico Diwaam 2 BHK, 2 BHK Flats in Kiwale, 2 BHK in Kiwale Ravet starts 70 Lacs, Harico Diwaam 2 BHK Price, Sentosa Diwaam 2 BHK, 2 BHK under 75 lakh Kiwale',
    highlights: [
  ...
  },
  {
    ...
    description: 'Experience ultra-luxury at Harico Diwaam in Kiwale. Designed for grand family celebrations and quiet sunset moments, our 3 BHK sky residences set a new standard for luxury in PCMC.',
    targetLocation: 'Kiwale',
    targetBhk: '3 BHK',
    metaKeywords: 'Harico Kiwale 3 BHK, Harico Diwaam 3 BHK, 3 BHK in Kiwale, 3 BHK Luxury High Rise Kiwale Ravet, Harico Diwaam 3 BHK Price, Tallest Towers 3 BHK Pune, Sentosa Diwaam 3 BHK, 3 BHK under 1 crore Kiwale',
    highlights: [
  ...
  },
  {
    ...
    description: 'At Harico Estates, regulatory compliance and customer security are non-negotiable. Every phase of Harico Edge (P52100031773), Harico Diwaam (PR1260002502389), and Harico Pride (P52100018471) is fully vetted and approved on the official MahaRERA portal.',
    metaKeywords: 'MahaRERA Approved Projects Pune, Harico Edge RERA P52100031773, Harico Diwaam RERA PR1260002502389, Harico Pride RERA P52100018471, Verified Real Estate PCMC',
    highlights: [
  ...
  // 4. Exact-Match Keyword Landing Pages for Search Hardening
  {
    ...
    title: 'Harico New Launch Kiwale & Punawale 2026 | Harico Diwaam & Harico Edge',
    eyebrow: '🔥 Mega New Launch 2026',
    subtitle: 'Pre-launch updates, launch price offers & possession schedules for Harico Diwaam Kiwale (Dec 2030) and Harico Edge Punawale (June 2030). Starts ₹70.00 Lacs* (3 BHK from ₹89.90 Lacs*).',
  ...
  },
  {
    ...
    eyebrow: 'Signature Sky Landmark',
    subtitle: 'Official floor plans (724–1108 sq.ft), brochure PDF download, and price sheets for Harico Diwaam Kiwale. MahaRERA PR1260002502389.',
  ...
  },
  {
    ...
    subtitle: 'Explore Harico Kiwale residential enclaves by Sentosa Developers. 5-acre master plan, 5 iconic towers, and infrastructure connectivity near Mukai Chowk.',
  ...
  },
  {
    ...
    eyebrow: 'Punawale IT Growth Corridor',
    subtitle: 'Discover Harico Edge and Harico Pride in Punawale by Sentosa Developers. Premium residences 2 minutes from Mumbai-Pune Expressway & Bhumkar Chowk.',
    description: 'Harico Punawale encompasses the premier residential developments by Sentosa Developers in Punawale. With Harico Edge (June 2030) and Harico Pride (June 2027), homebuyers experience unmatched living standards near Hinjewadi Phase 1, Wakad, and PCMC.',
    targetLocation: 'Punawale',
    metaKeywords: 'Harico Punawale, Harico Edge Punawale, Harico Pride Punawale, Harico Estates Punawale, Sentosa Developers Punawale, Flats in Punawale, 2 BHK in Punawale, 3 BHK in Punawale, Bhumkar Chowk Flats, Hinjewadi proximity flats, Punawale Real Estate, हरिको पुनावळे, पुनावळे २ बीएचके',
    highlights: [
      'Strategic Location: 2 Mins to Mumbai-Pune Expressway & 12 Mins to Hinjewadi',
      'Multiple Ongoing Phases: Harico Edge (2030) & Harico Pride (2027)',
  ...
  },
  {
    ...
    description: 'Looking for flats opposite Sentosa Water Park Kiwale? Harico Diwaam is a 24-storey landmark development by Sentosa Developers. 5 acres, 5 sky towers, 100+ curated amenities, and unbeatable connectivity to Mukai Chowk, Ravet, and Hinjewadi.',
    targetLocation: 'Kiwale',
